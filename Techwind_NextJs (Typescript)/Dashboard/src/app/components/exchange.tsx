                ...
                <div className="">
                    <form action="">
                        <div className="grid grid-cols-1 gap-4">
                            ...
                            <div>
                                <Link href="#" className="py-[5px] px-4 inline-block me-1 font-semibold tracking-wide align-middle duration-500 text-sm text-center bg-emerald-600 hover:bg-emerald-700 border-emerald-600 hover:border-emerald-700 text-white rounded-md">Buy Now</Link>
                                <Link href="#" className="py-[5px] px-4 inline-block font-semibold tracking-wide align-middle duration-500 text-sm text-center bg-red-600 hover:bg-red-700 border-red-600 hover:border-red-700 text-white rounded-md">Sell Now</Link>
                            </div>
                        </div>
                    </form>
                </div> :''
