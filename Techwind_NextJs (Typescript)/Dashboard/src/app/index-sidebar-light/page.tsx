...
import WrapperThree from "../components/wrapper-three";
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center">
                        ...
                        <Link href="#" className="ms-1">
                            ...
                            <span className="size-10 items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-md border bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white sm:hidden inline-flex"><BiExport/> </span>
                        </Link>
                    </div>
                </div>
                <DataStates/>
