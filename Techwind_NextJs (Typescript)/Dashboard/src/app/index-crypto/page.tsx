                                            ...
                                            {cryptoData.map((item:CryptoData,index:number)=>{
                                                return(
                                                    <tr className="border-t border-gray-100 dark:border-gray-700" key={index}>
                                                        <td className="p-4"><Link href="" className="flex items-center hover:text-indigo-600 font-semibold"><Image src={item.image} width={44} height={44} className="size-11 rounded-full shadow-sm dark:shadow-gray-700 p-1.5 me-1" alt=""/> {item.name}</Link></td>
                                ...
                                <Simplebar className="h-[290px]">
                                    <table className="w-full text-start">
                                        ...
                                        <tbody className="border-t border-gray-100 dark:border-gray-800">
                                            {transections.map((item:Transections,index:number)=>{
                                                return(
                                                <tr key={index}>
                                                    ...
                                                    <td className="px-4 pt-3 text-center text-indigo-600">{item.wallet}</td>
                        ...
                        <div className="relative overflow-hidden rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900">
                            <div className="p-4 flex items-center justify-between border-b border-gray-100 dark:border-gray-800">
                                ...
                                <Simplebar className="p-4 h-[290px]">
                                    {orderCoin.map((item:OrderCoin,index:number)=>{
                                        return(
