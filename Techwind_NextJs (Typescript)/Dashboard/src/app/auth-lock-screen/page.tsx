                    ...
                    <div className="md:flex items-center">
                        <div className="xl:w-[30%] lg:w-1/3 md:w-1/2">
                            <div className="relative md:flex flex-col md:min-h-screen justify-center bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-700 md:px-10 py-10 px-4 z-1">
                                ...
                                <div className="text-center">
                                    <Image src='/images/client/05.jpg' width={96} height={96} sizes="100vw" placeholder="blur" blurDataURL="/images/client/05.jpg" className="mx-auto size-24 rounded-full shadow-sm dark:shadow-gray-700" alt=""/>
                        ...
                        <div className="xl:w-[70%] lg:w-2/3 md:w-1/2 flex justify-center mx-6 md:my-auto my-20">
                            <div>
                                <div className="relative">
                                    <div className="absolute top-20 start-20 bg-indigo-600/[0.02] size-[1200px] rounded-full"></div>
                                    <div className="absolute bottom-20 -end-20 bg-indigo-600/[0.02] size-[600px] rounded-full"></div>
                                </div>
