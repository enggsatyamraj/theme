                ...
                <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                    <div className="lg:col-span-4 md:col-span-5">
                        <div className="lg:-mt-[330px] -mt-[299px]">
                            <div className="rounded-md bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800">
                                <div className="text-center py-8 p-6 border-b border-gray-100 dark:border-gray-800">
                                    <Image src="/images/client/circle-logo.png" width={64} height={64} className="size-24 p-4 shadow-md mx-auto rounded-full block" alt="" />
                                    <h5 className="mt-5 text-xl font-semibold mb-0">CircleCi</h5>
                                ...
                                <div className="p-6">
                                    ...
                                    <ul className="list-none mt-4">
                                        <li className="flex mt-2 items-center font-medium"><Icon.MapPin className="size-4 text-amber-500 me-3"></Icon.MapPin><span className="text-slate-400 me-3">Location :</span> San Francisco</li>
                                        <li className="flex mt-2 items-center font-medium"><Icon.Link className="size-4 text-amber-500 me-3"></Icon.Link><span className="text-slate-400 me-3">Comapny :</span> circleci.com</li>
                                        <li className="flex mt-2 items-center font-medium"><Icon.DollarSign className="size-4 text-amber-500 me-3"></Icon.DollarSign><span className="text-slate-400 me-3">Revenue :</span> $ 5M / Annual</li>
                    ...
                    <div className="lg:col-span-8 md:col-span-7">
                        ...
                        <div className="grid lg:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                            {comapnyData.map((item:CompanyData,index:number)=>{
                                const Icon = item.icon
                                return(
                                    <div key={index}>
                                    <Link href="/page-job-detail" className="group flex  bg-white dark:bg-slate-900 transition-all duration-500 hover:scale-105 shadow-sm dark:shadow-gray-800 hover:shadow-md dark:hover:shadow-gray-700 ease-in-out items-center p-3 rounded-md">
