...
import { LuAirplay, LuAtom, LuChartBar, LuClock, LuMicroscope, LuCircleParkingOff, LuPizza, LuSearch, LuTablets, LuUsers } from 'react-icons/lu';
...
export const furnitureItem = [
    {
        image:"/images/furniture/i1.jpg",
        name:"Item name is #1",
        amount:"$145.00"
    },
    {
        image:"/images/furniture/i2.jpg",
        name:"Item name is #2",
        amount:"$145.00"
    },
    {
        image:"/images/furniture/i3.jpg",
        name:"Item name is #3",
        amount:"$145.00"
    },
    {
        image:"/images/furniture/i4.jpg",
        name:"Item name is #4",
        amount:"$145.00"
    },
    {
        image:"/images/furniture/i5.jpg",
        name:"Item name is #5",
        amount:"$145.00"
    },
    {
        image:"/images/furniture/i6.jpg",
        name:"Item name is #6",
        amount:"$145.00"
    },
    {
        image:"/images/furniture/i7.jpg",
        name:"Item name is #7",
        amount:"$145.00"
    },
    {
        image:"/images/furniture/i8.jpg",
        name:"Item name is #8",
        amount:"$145.00"
    },
] 
...
export const servicesTwo = [
    {
        ...
        title:"UX / UI Design",
        desc:"The phrasal sequence of the is now so that many campaign and benefit",
        class:"p-6 hover:shadow-xl hover:shadow-gray-100 dark:hover:shadow-gray-800 duration-500 rounded-2xl mt-6"
    },
    {
        icon:MdApi,
        title:"IOS App Designer",
        desc:"The phrasal sequence of the is now so that many campaign and benefit",
        class:"p-6 shadow-xl shadow-gray-100 dark:shadow-gray-800 duration-500 rounded-2xl mt-6"
    },
    {
        icon:TbCameraPlus,
        title:"Photography",
...
export const paymentFeature =[
    {
        ...
        desc:"The phrasal sequence of the is now so that many campaign and benefit",
        class:"hover:shadow-xl hover:shadow-gray-100 dark:hover:shadow-gray-800"
    },
    {
        icon:MdOutlineCalendarMonth,
        title:"Easy to use",
        desc:"The phrasal sequence of the is now so that many campaign and benefit",
        class:"shadow-xl shadow-gray-100 dark:shadow-gray-800"
    },
    {
        icon:RiMailSendLine,
        title:"Support",
