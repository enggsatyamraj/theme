...
export default function Page() {
    ...
    return (
        <>
            ...
            <PortfolioMasonryFilter columns="columns-2 gap-2" className="lg:w-3/4 mx-auto lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 grid-cols-1 mt-4 gap-[30px]" containerClass={false}  />
            <Footer />
            <Switcher/>
        </>
    )
