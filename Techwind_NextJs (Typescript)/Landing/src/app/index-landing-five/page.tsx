                ...
                <div className="grid lg:grid-cols-12 md:grid-cols-2 gap-[30px] mt-10 items-center">
                    ...
                    <div className="lg:col-span-5">
                        <div className="relative">
                            <div className="relative">
                                <img src="/images/avatar.jpg" className="lg:w-[400px] w-[280px] rounded-lg shadow-sm dark:shadow-gray-800" alt="" />
                                <VideoModalTwo/>
                            </div>
                            <div className="absolute -end-5 -bottom-16">
                                <img src="/images/law/ab2.jpg" className="lg:w-[280px] w-[200px] border-8 border-white dark:border-slate-900 rounded-lg shadow-sm dark:shadow-gray-800" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid md:grid-cols-3 grid-cols-1 mt-8 gap-[30px]">
                    {featureOne.map((item:Feature,index:number)=>{
                        ...
                        return(
                            ...
                            <div className="w-20 h-20 bg-indigo-600/5 text-indigo-600 rounded-lg ltr:rotate-[15deg] rtl:-rotate-[15deg] flex align-middle justify-center items-center shadow-xs dark:shadow-gray-800 mx-auto">
