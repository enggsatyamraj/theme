        ...
        <section className="relative md:py-24 py-16">
            <div className="container relative">
                <div className="grid grid-cols-1">
                    <div className="rounded-md shadow-sm dark:shadow-gray-800 overflow-hidden">
                        <div className="md:flex items-center">
                            <div className="relative md:shrink-0">
                                <img src="/images/photography/about.jpg" className="h-full w-full object-cover lg:w-[500px] md:w-80 lg:h-full md:h-96" alt="" />
                            </div>
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 justify-center gap-[30px]">
                    {photoAboutImage.map((data:string,index:number) => {
                        return (
                            <div className="mx-auto" key={index}>
                                <Image src={data} width={0} height={0} sizes='100vw' style={{width:"100%", height:"auto"}} className="!size-[110px] grayscale hover:grayscale-0 duration-500 ease-in-out" alt="" />
                            </div>
                        )
                    })}
                </div>
