...
export default function AccountingTab(){
    ...
    return(
        ...
        <div className="lg:col-span-9 md:col-span-7">
            <div id="myTabContent" className="p-6 bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800 rounded-md">
                    ...
                    <div className="relative overflow-x-auto shadow-sm dark:shadow-gray-800 rounded-md">
                        <table className="w-full text-start text-slate-500 dark:text-slate-400">
                            ...
                            <tbody>
                                ...
                                <tr className="bg-white dark:bg-slate-900 text-start border-t border-gray-100 dark:border-gray-800">
