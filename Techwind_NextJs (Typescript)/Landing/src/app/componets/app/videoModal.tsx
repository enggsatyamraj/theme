...
export default function VideoModal(){
    ...
    return(
        ...
        <div className="absolute top-4 md:end-14 -end-2 text-center">
            <Link href="#" onClick={()=>setOpen(!isOpen)} scroll={false} className="lightbox size-20 rounded-full shadow-md dark:shadow-gyay-700 inline-flex items-center justify-center text-white bg-indigo-600">
