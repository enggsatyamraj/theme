...
export default function Cta(){
    ...
    return(
        <section className="py-20 w-full table relative bg-center bg-no-repeat bg-cover" style={{backgroundImage:"url('/images/digital/bg01.jpg')"}}>
            <div className="container relative">
                <div className="flex">
                    <div className="lg:w-1/3 md:1/2 sm:w-2/3 p-6 rounded-md shadow-md dark:shadow-gray-800 bg-white dark:bg-slate-900">
                        ...
                        <h4 className="mb-4 md:text-[28px]] text-2xl leading-normal font-bold">Leading Digital <br /> Business For 
                        <TypeAnimation
                            sequence={[
                                ' Agency',
                                2000,
                            ...
                            wrapper="span"
                            speed={50}
                            className="text-indigo-600 typewrite"
                            repeat={Infinity}
                            cursor={false}
                        />
                         <br /> Solution.</h4>
            ...
            {isModal ? 
            <div id="contactModal"className="bg-slate-900/80 dark:bg-slate-900/70 fixed inset-0 z-40 flex items-center justify-center">
