...
export default function VideoModalTwo(){
    ...
    return(
        ...
        <div className="absolute bottom-0 end-0 text-center">
            <Link href="#" onClick={()=>setOpen(!isOpen)} scroll={false} className="lightbox size-14 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center bg-indigo-600 text-white">
