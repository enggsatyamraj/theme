...
export default function PortfolioMasonryFilter({className,containerClass,columns }:{className:string,containerClass:boolean,columns:string }) {
            ...
            {containerClass === true ?
                <>
                    ...
                    <div className={columns}>
                        {
                            filteredData.map((data:WorkData, index:number) => {
                                return (
