                    ...
                    <div>
                        <div className="grid grid-cols-1">
                            ...
                            <div className="flex items-center mt-3">
                                <Image src="/images/client/08.jpg" width={64} height={64} className="size-16 rounded-full shadow-md dark:shadow-gray-800" alt="" />
                        ...
                        <div className="grid grid-cols-1">
                            <div className="flex items-center">
                                <div className="relative">
                                    <Image width={64} height={64} src="/images/client/01.jpg" className="size-16 rounded-full shadow-md dark:shadow-gray-800" alt="" />
                                </div>
                            ...
                            <div className="flex items-center mt-4">
                                <div className="relative">
                                    <Image width={64} height={64} src="/images/client/02.jpg" className="size-16 rounded-full shadow-md dark:shadow-gray-800" alt="" />
                                </div>
                            ...
                            <div className="flex items-center mt-4">
                                <div className="relative">
                                    <Image width={64} height={64} src="/images/client/03.jpg" className="size-16 rounded-full shadow-md dark:shadow-gray-800" alt="" />
                                </div>
                    ...
                    <div>
                        <div className="grid grid-cols-1">
                            <div className="rounded-md shadow-sm dark:shadow-gray-800 p-6">
                                <div className="flex items-center">
                                    <div className="relative">
                                        <Image width={80} height={80} src="/images/nft/items/1.jpg" className="size-20 rounded-md shadow-md dark:shadow-gray-800" alt="" />
