    ...
    return(
        ...
        <div className="container relative">
            <div className="grid grid-cols-1 text-center">
                <h3 className="mb-6 md:text-4xl text-3xl !font-ebgaramond text-white font-medium">Stop leaving money on the table.</h3>
                ...
                <Link href="#" onClick={()=>setOpen(!isOpen)} scroll={false} className="lightbox size-20 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-indigo-600 mx-auto mt-10">
