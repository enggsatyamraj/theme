...
export default function ClientsOne({title,clients}:{title:boolean,clients:string}){
    const settings = {
                                ...
                                <div className="tiny-slide text-center" key={index}>
                                    <div className="cursor-e-resize">
                                        ...
                                        <div className="text-center mt-5">
                                            <Image src={item.image} width={0} height={0} sizes="100vw" style={{width:"56px", height:"auto"}} className="size-14 rounded-full shadow-md mx-auto" alt="" />
