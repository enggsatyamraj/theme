...
export default function KeyFeature({btnFill}:{btnFill:boolean}){
    return(
        <div className="container ">
            ...
            <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px] mt-8">
                {KeyFeatures.map((item:Feature,index:number)=>{
                    const Icon = item.Icon
                    return(
                        <div className="lg:col-span-4 md:col-span-6" key={index}>
                        <div className="flex duration-500 hover:scale-105 shadow-sm  dark:shadow-gray-800 hover:shadow-md dark:hover:shadow-gray-700 ease-in-out items-center p-3 rounded-md bg-white dark:bg-slate-900">
