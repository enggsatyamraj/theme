            ...
            <div className="container relative">
                ...
                <ul className="buy-button list-none space-x-1 mb-0">
                    ...
                    <li className="inline-block ps-1 mb-0">
                        <Link href="#" id="connectWallet" onClick={connectMetamaskWallet}  className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-indigo-600 hover:bg-indigo-700 border border-indigo-600 hover:border-indigo-700 text-white"><BiWallet/></Link>
                    </li>
                            ...
                            <div className="relative">
                                ...
                                <div className="absolute px-4 -bottom-7 start-0">
                                    <div className="flex items-end">
                                        <Image src="/images/client/05.jpg" width={34} height={34} className="rounded-full w-10 h-w-10 shadow-sm dark:shadow-gray-700" alt="" />
                ...
                <div id="navigation" style={{ display: isMenu ? 'block' : 'none' }}>
                    <ul className="navigation-menu nav-left !justify-start">
