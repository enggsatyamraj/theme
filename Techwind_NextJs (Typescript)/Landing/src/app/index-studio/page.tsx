                ...
                <div className="grid lg:grid-cols-12 grid-cols-1 mt-8 gap-[30px]">
                    ...
                    <div className="lg:col-span-9">
                        <div className="grid md:grid-cols-2 grid-cols-1 gap-[30px]">
                                    {studioAbout.map((item:AboutData,index:number)=>{
                                        let Icons = item.icon
                                            return(
                                            <div key={index} className="p-6 rounded-lg shadow-sm dark:shadow-gray-800 bg-white dark:bg-slate-900">
                                                <div
                                                    className="w-16 h-16 bg-indigo-600/5 border-2 border-indigo-600/20 text-indigo-600 rounded-lg text-2xl flex align-middle justify-center items-center shadow-xs dark:shadow-gray-800">
