     ...
     <section className="relative flex items-center w-full py-36 lg:py-0 lg:h-screen" id="home" style={{backgroundImage:`url(${images[currentImageIndex]})`}}>
        ...
        <div className="container relative">
            <div className="grid grid-cols-1 pb-8 text-center mt-14">
                ...
                <p className="text-slate-300 text-lg max-w-xl mx-auto">Launch your campaign and benefit from our expertise on designing and managing conversion centered Tailwind CSS v4.x html page.</p>
    ...
    <section className="relative md:py-24 py-16">
                    ...
                    <div className="relative">
                        <div className="relative">
                            ...
                            <div className="absolute top-0 translate-y-2/4 end-0 text-center">
                                <Link href="#!" scroll={false} onClick={()=>setOpen(!isOpen)} className="lightbox size-20 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-indigo-600 dark:text-white">
        ...
        <div className="container relative md:mt-24 mt-16">
            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 mt-4 gap-[30px]">
                {cleaningServices.map((item:Services,index:number)=>{
                    let Icon = item.icon
                    return(
    ...
    <section className="py-20 w-full table relative bg-fixed bg-center bg-no-repeat bg-cover" style={{backgroundImage:`url('/images/cleaner/bg.jpg')`}}>
        ...
        <div className="container relative">
            <div className="relative grid md:grid-cols-3 grid-cols-1 items-center mt-8 gap-[30px] z-1">
                {cleanerCounter.map((item:Counter,index:number)=>{
                    return(
    ...
    <section className="relative md:py-24 py-16">
        <div className="container relative">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 mt-8 gap-[30px]">
                {clenerServices.map((item:Services2,index:number)=>{
                    return(
        ...
        <div className="container relative md:mt-24 mt-16">
            ...
            <div className="grid md:grid-cols-12 grid-cols-1 mt-8 gap-[30px]">
                {clenerTeam.map((item:Team,index:number)=>{
                    return(
        ...
        <div className="container relative md:mt-24 mt-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 mt-8 gap-[30px]">
                {clenerBlog.map((item:BlogData,index:number)=>{
                    return(
