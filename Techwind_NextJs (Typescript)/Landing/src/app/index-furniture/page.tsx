        ...
        <section className="relative md:py-24 py-16">
            <div className="container relative">
                <div className="grid md:grid-cols-2 grid-cols-1 gap-[30px]">
                    <div className="group relative overflow-hidden shadow-sm dark:shadow-gray-800">
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    {furnitureItem.map((item:FurnitureData,index:number)=>{
                        return(
                            <div className="group" key={index}>
                                <div className="relative overflow-hidden shadow-sm dark:shadow-gray-800">
        ...
        <section className="relative md:py-24 py-16">
            <div className="container relative">
                ...
                <div className="grid md:grid-cols-3 grid-cols-1 mt-8 gap-[30px]">
                    {featuredcollections.map((item:Collections,index:number)=>{
                        return(
                            <div key={index} className="group relative overflow-hidden shadow-sm dark:shadow-gray-800">
                                <Image src={item.image} width={0} height={0} sizes='100vw' style={{width:"100%", height:"auto"}} className="group-hover:scale-105 transition-all duration-500" alt="" />
            ...
            <div className="container relative md:mt-24 mt-16">
                <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-[30]">
                    {furnitureServices.map((item:Services,index:number)=>{
                        let Icons = item.icon
                        return(
