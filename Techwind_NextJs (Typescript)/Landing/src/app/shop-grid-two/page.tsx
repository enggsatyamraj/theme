            ...
            <div className="container">
                <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                    <div className="lg:col-span-4 md:col-span-6">
                        <div className="shadow-sm dark:shadow-gray-800 p-6 rounded-md bg-white dark:bg-slate-900 sticky top-20">
                            <form>
                                    ...
                                    <div>
                                        ...
                                        <div className="block mt-2">
                                            <span className="flex items-center">
                                                <Image src="/images/shop/items/s1.jpg" width={48} height={60} className="rounded shadow-sm dark:shadow-gray-800 w-12" alt="" />
                                                <span className="ms-3">
                                        ...
                                        <div className="block mt-2">
                                            <span className="flex items-center">
                                                <Image src="/images/shop/items/s2.jpg" width={48} height={60} className="rounded shadow-sm dark:shadow-gray-800 w-12" alt="" />
                                                <span className="ms-3">
                                        ...
                                        <div className="block mt-2">
                                            <span className="flex items-center">
                                                <Image src="/images/shop/items/s3.jpg" width={48} height={60} className="rounded shadow-sm dark:shadow-gray-800 w-12" alt="" />
                                                <span className="ms-3">
                    ...
                    <div className="lg:col-span-8 md:col-span-6">
                        ...
                        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                            ...
                            return(
                                ...
                                <div className="relative overflow-hidden shadow-sm dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md transition-all duration-500">
