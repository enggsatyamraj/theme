            ...
            <div className="container">
                <div className="grid md:grid-cols-12 gap-[30px]">
                        ...
                        <div className="group profile-pic w-[112px]">
                            ...
                            <div>
                                <div className="relative size-28 rounded-full shadow-md dark:shadow-gray-800 ring-4 ring-slate-50 dark:ring-slate-800 overflow-hidden">
                                    {file ? 
                                        <Image src={file} width={112} height={112} className="rounded-full" id="profile-image" alt="" /> :
                    ...
                    <div className="lg:col-span-9 md:col-span-8">
                        ...
                        <div className="p-6 rounded-md shadow-sm dark:shadow-gray-800 bg-white dark:bg-slate-900 mt-[30px]">
                                ...
                                <div className="md:w-2/3 mt-4 md:mt-0">
                                    <form>
                                        <div className="form-icon relative">
                                            <FiTwitter className="size-4 absolute top-3 start-4"/>
                            ...
                            <div className="md:flex mt-8">
                                ...
                                <div className="md:w-2/3 mt-4 md:mt-0">
                                    <form>
                                        <div className="form-icon relative">
                                            <FiFacebook className="size-4 absolute top-3 start-4"/>
                                            <input type="text" className="form-input ps-12 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0" placeholder="Facebook Profile Name" id="facebook_name" name="name" />
                                        </div>
                                    </form>
                            ...
                            <div className="md:flex mt-8">
                                ...
                                <div className="md:w-2/3 mt-4 md:mt-0">
                                    <form>
                                        <div className="form-icon relative">
                                            <FiInstagram className="size-4 absolute top-3 start-4"/>
                                            <input type="text" className="form-input ps-12 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0" placeholder="Instagram Profile Name" id="insta_name" name="name" />
                                        </div>
                                    </form>
                            ...
                            <div className="md:flex mt-8">
                                ...
                                <div className="md:w-2/3 mt-4 md:mt-0">
                                    <form>
                                        <div className="form-icon relative">
                                            <FiLinkedin className="size-4 absolute top-3 start-4"/>
                                            <input type="text" className="form-input ps-12 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0" placeholder="Linkedin Profile Name" id="linkedin_name" name="name" />
                                        </div>
                                    </form>
                            ...
                            <div className="md:flex mt-8">
                                ...
                                <div className="md:w-2/3 mt-4 md:mt-0">
                                    <form>
                                        <div className="form-icon relative">
                                            <FiYoutube className="size-4 absolute top-3 start-4"/>
                                            <input type="url" className="form-input ps-12 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0" placeholder="Youtube url" id="you_url" name="url" />
                                        </div>
                                    </form>
                        ...
                        <div className="p-6 rounded-md shadow-sm dark:shadow-gray-800 bg-white dark:bg-slate-900 mt-[30px]">
                            ...
                            <div className="flex justify-between py-4 border-t border-gray-100 dark:border-gray-800">
                                    ...
                                    <form>
                                        <div className="grid grid-cols-1 gap-5">
                                            <div>
                                                ...
                                                <input type="password" className="form-input w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 mt-2" placeholder="Old password" />
                                            </div>

                                            <div>
                                                <label className="form-label font-medium">New password :</label>
                                                <input type="password" className="form-input w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 mt-2" placeholder="New password" />
                                            </div>

                                            <div>
                                                <label className="form-label font-medium">Re-type New password :</label>
                                                <input type="password" className="form-input w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 mt-2" placeholder="Re-type New password" />
                                            </div>
                                        </div>
