            ...
            <div className="container relative">
                <div className="md:flex">
                    <div className="relative lg:w-2/3 w-full -mt-32">
                        <div className="px-6 py-12 bg-white dark:bg-slate-900 rounded-md shadow-sm dark:shadow-gray-800 text-center">
                            ...
                            <div className="flex items-center justify-center mt-5">
                                <div className="flex items-center mx-2">
                                    <Image src="/images/client/05.jpg" width={28} height={28} className="size-7 rounded-full shadow-md dark:shadow-gray-800" alt="" />
                ...
                <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                    <div className="lg:col-span-8 md:col-span-6">
                        <div>
                            ...
                            <div className="grid md:grid-cols-2 grid-cols-1 mt-6 gap-[30px]">
                                <Image src="/images/food/blog/f1.jpg" width={0} height={0} sizes='100vw' style={{width:"100%", height:"auto"}} className="rounded-md shadow-sm" alt="" />

                                <div className="relative">
                                    <Image src="/images/food/blog/f2.jpg" width={0} height={0} sizes='100vw' style={{width:"100%", height:"auto"}} className="rounded-md shadow-sm" alt="" />
                                    <VideoModal/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-6 rounded-md shadow-sm dark:shadow-gray-800 mt-8">
                            ...
                            {foodComment.map((item:Comments,index:number)=>{
                                return(
                                    <div className="mt-8" key={index}>
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center">
                                                <Image src={item.image} width={44} height={44} className="size-11 rounded-full shadow-sm" alt="" />
                    ...
                    <div className="lg:col-span-4 md:col-span-6">
                        <div className="sticky top-20">
                            <h5 className="text-lg font-semibold bg-gray-50 dark:bg-slate-800 shadow-sm dark:shadow-gray-800 rounded-md p-2 text-center">Author</h5>
                            <div className="text-center mt-8">
                                <Image src="/images/client/05.jpg" width={96} height={96} className="size-24 mx-auto rounded-full shadow-sm mb-4" alt="" />
                            ...
                            <h5 className="text-lg font-semibold bg-gray-50 dark:bg-slate-800 shadow-sm dark:shadow-gray-800 rounded-md p-2 text-center mt-8">Recent post</h5>
                            <div className="flex items-center mt-8">
                                <Image src="/images/food/blog/6.jpg" width={64} height={64} className="h-16 rounded-md shadow-sm dark:shadow-gray-800" alt="" />
                            ...
                            <div className="flex items-center mt-4">
                                <Image src="/images/food/blog/7.jpg" width={64} height={64} className="h-16 rounded-md shadow-sm dark:shadow-gray-800" alt="" />
                            ...
                            <div className="flex items-center mt-4">
                                <Image src="/images/food/blog/8.jpg" width={64} height={64} className="h-16 rounded-md shadow-sm dark:shadow-gray-800" alt="" />
                            ...
                            <ul className="list-none text-center mt-8 space-x-1">
                                <li className="inline-block m-2"><Link href="#" className="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-indigo-600 dark:hover:bg-indigo-600 rounded-md shadow-sm dark:shadow-gray-800 transition-all duration-500 ease-in-out">Food</Link></li>
                                <li className="inline-block m-2"><Link href="#" className="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-indigo-600 dark:hover:bg-indigo-600 rounded-md shadow-sm dark:shadow-gray-800 transition-all duration-500 ease-in-out">Chicken</Link></li>
                                <li className="inline-block m-2"><Link href="#" className="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-indigo-600 dark:hover:bg-indigo-600 rounded-md shadow-sm dark:shadow-gray-800 transition-all duration-500 ease-in-out">Recipe</Link></li>
                                <li className="inline-block m-2"><Link href="#" className="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-indigo-600 dark:hover:bg-indigo-600 rounded-md shadow-sm dark:shadow-gray-800 transition-all duration-500 ease-in-out">Enjoy</Link></li>
                                <li className="inline-block m-2"><Link href="#" className="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-indigo-600 dark:hover:bg-indigo-600 rounded-md shadow-sm dark:shadow-gray-800 transition-all duration-500 ease-in-out">Restra</Link></li>
                                <li className="inline-block m-2"><Link href="#" className="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-indigo-600 dark:hover:bg-indigo-600 rounded-md shadow-sm dark:shadow-gray-800 transition-all duration-500 ease-in-out">Sunday</Link></li>
                                <li className="inline-block m-2"><Link href="#" className="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-indigo-600 dark:hover:bg-indigo-600 rounded-md shadow-sm dark:shadow-gray-800 transition-all duration-500 ease-in-out">Offer</Link></li>
                                <li className="inline-block m-2"><Link href="#" className="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-indigo-600 dark:hover:bg-indigo-600 rounded-md shadow-sm dark:shadow-gray-800 transition-all duration-500 ease-in-out">Holiday</Link></li>
                                <li className="inline-block m-2"><Link href="#" className="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-indigo-600 dark:hover:bg-indigo-600 rounded-md shadow-sm dark:shadow-gray-800 transition-all duration-500 ease-in-out">Cake</Link></li>
                                <li className="inline-block m-2"><Link href="#" className="px-3 py-1 text-slate-400 hover:text-white dark:hover:text-white bg-gray-50 dark:bg-slate-800 text-sm hover:bg-indigo-600 dark:hover:bg-indigo-600 rounded-md shadow-sm dark:shadow-gray-800 transition-all duration-500 ease-in-out">Burns</Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="mt-8">
                            <div className="text-center subcribe-form">
                                <form className="relative mx-auto max-w-xl">
                                    <input type="email" id="subemail" name="name" className="pt-4 pe-40 pb-4 ps-6 w-full h-[50px] outline-none text-black dark:text-white rounded-full bg-white/70 dark:bg-slate-900/70 border border-gray-100 dark:border-gray-800" placeholder="Enter your email id.." />
