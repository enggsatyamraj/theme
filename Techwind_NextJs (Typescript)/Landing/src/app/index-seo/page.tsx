                       ...
                       <TextAnimation/>
                        ...
                        <div className="subcribe-form mt-6 mb-3">
                            <form className="relative max-w-xl mx-auto">
                                <input type="url" id="site-url" name="url" className="pt-4 pe-40 pb-4 ps-6 w-full h-[50px] outline-none text-black dark:text-white rounded-full bg-white/60 dark:bg-slate-900/60 shadow-sm dark:shadow-gray-800 border-gray-100  dark:border-gray-800" placeholder="http://www.yourdomain.com" />
        ...
        <section className="relative md:pb-24 pb-16">
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 mt-6 gap-[30px]">
                    {SeoServece.map((item:ServicesData,index:number)=>{
                        let Icons = item.icon
                        return(
        ...
        <section className="realtive md:py-24 py-16">
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    {clientsDataTwo.map((item:ClientData,index:number)=>{
                        return(
