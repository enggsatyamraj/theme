                ...
                <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                    <div className="lg:col-span-8 md:col-span-6">
                        <div className="p-6 rounded-md shadow-sm dark:shadow-gray-800">
                            ...
                            <iframe  title='google' src="https://player.vimeo.com/video/99025203" className="w-full" allow="autoplay; encrypted-media" style={{height: 433+'px'}} allowFullScreen></iframe>

                            <div className="text-center mt-12">
                                <span className="bg-indigo-600 inline-block text-white text-xs font-semibold px-2.5 py-0.5 rounded-full h-5">Vimeo</span>
                                <h3 className="my-3 text-[26px] font-semibold">The power of video at your fingertips</h3>
