        ...
        <section className="relative table w-full py-36 lg:py-64 bg-no-repeat bg-center bg-cover" style={{backgroundImage:"url('/images/corporate/bg.jpg')"}}>
            ...
            <div className="container relative">
                <div className="grid grid-cols-1 text-center mt-10">
                    ...
                    <p className="text-white/60 text-lg max-w-xl mx-auto">Launch your campaign and benefit from our expertise on designing and managing conversion centered Tailwind CSS v4.x html page.</p>
        ...
        <section className="relative bg-indigo-600 py-10">
            <div className="container relative">
                <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1">
                    {
                        corporateAboutTwo.map((item:About,index:number)=>{
                            let Icons = item.icon
                            return(
        ...
        <section className="relative md:py-24 py-16">
            ...
            <div className="container relative md:mt-24 mt-16 pt-16">
                ...
                <div className="relative grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    {corporateService.map((item:Services,index:number)=>{
                        let Icons = item.icon
                        return(
                            <div key={index} className="group px-6 py-8 bg-white dark:bg-slate-900 shadow-sm hover:shadow-lg dark:hover:shadow-gray-800 duration-500 ease-in-out border-t-[3px] border-gray-100 dark:border-gray-800 hover:border-indigo-600 dark:hover:border-indigo-600">
                        ...
                        <div className="">
                            <div className="relative">
                                <div className="shadow-sm dark:shadow-gray-800 p-5 pb-0 rounded-md bg-indigo-600/5 dark:bg-indigo-600/30">
                                    <Image src="/images/portfolio/01.jpg" width={0} height={0} sizes="100vw" style={{width:"100%", height:"auto" }} className="rounded-t-md shadow-sm" alt="" />
                                </div>
                            </div>
                        ...
                        <div className="">
                            <div className="relative">
                                <div className="shadow-sm dark:shadow-gray-800 p-5 pb-0 rounded-md bg-emerald-600/5 dark:bg-emerald-600/30">
                                    <Image src="/images/portfolio/02.jpg" width={0} height={0} sizes="100vw" style={{width:"100%", height:"auto" }} className="rounded-t-md shadow-sm" alt="" />
                                </div>
                            </div>
