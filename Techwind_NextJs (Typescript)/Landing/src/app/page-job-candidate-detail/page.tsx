            ...
            <div className="container relative">
                <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                        ...
                        <div className="lg:-mt-[330px] -mt-[299px]">
                            <div className="rounded-md bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800">
                                <div className="text-center py-8 p-6 border-b border-gray-100 dark:border-gray-800">
                                    <Image src="/images/client/01.jpg" width={96} height={96} className="size-24 p-1 shadow-md dark:shadow-gray-800 mx-auto rounded-full block" alt="" />
                    ...
                    <div className="lg:col-span-8 md:col-span-7">
                        ...
                        <p className="text-slate-400 mt-4">Obviously I am Web Developer. Web Developer with over 3 years of experience. Experienced with all stages of the development cycle for dynamic web projects. The as opposed to using Content here, content here, making it look like readable English.</p>
                        ...
                        <div className="flex mt-6">
                            <div className="text-slate-400 font-semibold min-w-[80px] text-center">
                                <Image src="/images/client/shree-logo.png" width={64} height={64} className="size-16 mx-auto mb-2 block" alt="" /> 2019-22
                            </div>
                        ...
                        <div className="flex mt-6">
                            <div className="text-slate-400 font-semibold min-w-[80px] text-center">
                                <Image src="/images/client/circle-logo.png" width={64} height={64} className="size-16 mx-auto mb-2 block" alt="" /> 2017-19
                            </div>
