    ...
    return(
            ...
            <div className="container relative">
                <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                    <div className="lg:col-span-5 md:col-span-6">
                        <Image src="/images/food/about.jpg" width={0} height={0} sizes='100vw' style={{width:"100%", height:"auto"}} className="rounded-md shadow-sm dark:shadow-gray-800" alt="" />
                    </div>
                            ...
                            <form>
                                <div className="grid md:grid-cols-2 gap-4 mt-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" min="0" autoComplete="off" id="adult" className="form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0" placeholder="Person :" />
                                    </div>
        ...
        <section className="relative md:py-24 py-16 bg-indigo-600/5">
            <div className=" relative">
                <ClientsOne clients="Happy Clients" title={false}/>
            </div>
        </section>
