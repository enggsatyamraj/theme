        ...
        <section className="relative md:py-24 py-16">
            <div className="container relative">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 mt-8 gap-x-[30px] gap-y-[50px]">
                    ...
                    {
                        servicesOne.map((data:Services,index:number) => {
                            let Icons = data.icon
                            return (
                                <div className="text-center md:px-3" key={index}>
                                    <div className="size-24 bg-indigo-600/5 text-indigo-600 rounded-3xl text-4xl flex align-middle justify-center items-center shadow-xs dark:shadow-gray-800 mx-auto">
        ...
        <section className="relative md:py-24 py-16 bg-gray-50 dark:bg-slate-800">
            <div className="container relative">
                ...
                <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    {pricingTwo.map((item:Pricing,index:number)=>{
                        return(
                            <div className="group rounded-md shadow-sm bg-white dark:bg-slate-900" key={index}>
