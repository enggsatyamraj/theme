                        ...
                        <div className="ms-6">
                            ...
                            <div className="subcribe-form mt-6">
                                <form className="relative max-w-xl">
                                    <input type="email" id="subemail" name="name" className="pt-4 pe-40 pb-4 ps-6 w-full h-[50px] outline-none text-black dark:text-white rounded-full bg-white/70 dark:bg-slate-900/70 border border-gray-100 dark:border-gray-800" placeholder="Search Phone Number." />
        ...
        <section className="relative md:py-24 py-16">
            <div className="container relative">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 mt-6 gap-[30px]">
                    {aboutTwo.map((item:AboutTwo,index:number)=>{
                        let Icons = item.icon
                        return(
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    {
                        mobileNumber.map((data:MobileNumber,index:number) => {
                            return (
