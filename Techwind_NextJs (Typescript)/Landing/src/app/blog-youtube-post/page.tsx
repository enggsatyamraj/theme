                    ...
                    <div className="lg:col-span-8 md:col-span-6">
                        <div className="p-6 rounded-md shadow-sm dark:shadow-gray-800">
                            ...
                            <div className="relative overflow-hidden rounded-md">
                                <iframe  title='google' src="https://www.youtube.com/embed/S_CGed6E610?feature=oembed" className="w-full" allow="autoplay; encrypted-media" style={{height: 433+'px'}} allowFullScreen></iframe>
                            </div>

                            <div className="text-center mt-12">
                                <span className="bg-indigo-600 inline-block text-white text-xs font-semibold px-2.5 py-0.5 rounded-full h-5">Youtube</span>
                                <h3 className="my-3 text-[26px] font-semibold">1 Hour Pine Forest In 4K Relaxing Nature Sounds</h3>
