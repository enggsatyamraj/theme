                        ...
                        <div className="grid grid-cols-12 gap-4 items-center">
                            <div className="col-span-5">
                                <div className="grid grid-cols-1 gap-4">
                                    <Image src="/images/digital/02.jpg" width={0} height={0} sizes='100vw' style={{width:"100%",height:"auto"}} className="shadow-sm rounded-lg" alt="" />
                            ...
                            <div className="col-span-7">
                                <div className="grid grid-cols-1 gap-4">
                                    <Image src="/images/digital/01.jpg" width={0} height={0} sizes='100vw' style={{width:"100%",height:"auto"}} className="shadow-sm rounded-lg" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section className="relative md:py-24 py-16">
            <div className="container relative">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 mt-8 gap-[30px]">
                    {digitalServices.map((item:Services,index:number)=>{
                        let Icons = item.icon
                        return(
                            <div key={index} className="text-center md:px-6">
                                <div className={`${item.background} w-28 h-28  rounded-3xl text-4xl flex align-middle justify-center items-center shadow-xs dark:shadow-gray-800 mx-auto`}>
                                    <Icons className='w-8 h-8'/>
                                </div>

                                <div className="content mt-7">
                                    <Link href="/page-services" className={`title h5 text-lg font-medium ${item.text}`}>{item.title}</Link>
                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                    <div className="md:col-span-6">
                        <div className="grid grid-cols-12 gap-4 items-center">
                            <div className="col-span-7">
                                <div className="grid grid-cols-1 gap-4">
                                    <Image src="/images/digital/03.jpg" width={0} height={0} sizes='100vw' style={{width:"100%", height:"auto"}} className="shadow-sm rounded-lg" alt="" />
                                </div>
                            </div>

                            <div className="col-span-5">
                                <div className="grid grid-cols-1 gap-4">
                                    <Image src="/images/digital/04.jpg" width={0} height={0} sizes='100vw' style={{width:"100%", height:"auto"}} className="shadow-sm rounded-lg" alt="" />
        ...
        <section className="relative md:py-24 py-16">
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 mt-4" id="grid">
                    {digitalProduct.map((item:Product,index:number)=>{
                        return(
