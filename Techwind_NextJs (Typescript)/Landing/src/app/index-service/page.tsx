                        ...
                        <div className="md:me-6">
                            ...
                            <div className="subcribe-form z-1 mt-8">
                                <form className="relative mx-auto max-w-2xl">
                                    ...
                                    <input type="text" id="SearchForumKeyword" name="text" className="pt-4 pe-40 pb-4 w-full h-[50px] outline-none text-black dark:text-white  bg-white/70 dark:bg-slate-900/70 border border-gray-100 dark:border-gray-800 ps-10" placeholder="What service are you looking for?" />
        ...
        <section className="relative md:pb-24 pb-16">
            <div className="container relative">
                ...
                <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    {discoverData.map((item:DiscoverData,index:number)=>{
                        let Icons = item.icon
                        return(
                            <div key={index} className="group transition-all duration-500 ease-in-out text-center">
                                <div className="flex align-middle mx-auto justify-center items-center w-14 h-14 mt-1 bg-indigo-600/5 group-hover:bg-indigo-600 group-hover:text-white border-2 border-indigo-600/20 text-indigo-600 rounded-lg text-2xl shadow-xs dark:shadow-gray-800 transition-all duration-500 ease-in-out">
