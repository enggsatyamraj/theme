                            ...
                            <div className="p-6 rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900">
                                <div className="border-b border-gray-100 dark:border-gray-700 pb-6">
                                    <div className="md:flex justify-between">
                                        <div>
                                            <Image src='/images/logo-dark.png' width={138} height={24} placeholder="blur" blurDataURL='/images/logo-dark.png' className="block dark:hidden" alt=""/>
                                            <Image src='/images/logo-light.png' width={138} height={24} placeholder="blur" blurDataURL='/images/logo-light.png' className="hidden dark:block" alt=""/>
                                            <div className="flex mt-4">
                                                <Icon.Link className="size-4 me-3 mt-1"/>
                                                <Link href="https://1.envato.market/techwind-next" target="_blank" className="text-indigo-600 dark:text-white font-medium">https://1.envato.market/techwind-next</Link>
                                            </div>
                                        </div>
                                    ...
                                    <div className="md:flex justify-between">
                                        <div>
                                            <div className="text-slate-400 text-center md:text-start">
                                                <h6 className="mb-0">Customer Services : <Link href="#" className="text-amber-500">(+12) 1546-456-856</Link></h6>
                                            </div>
                                        </div>
