                        ...
                        <div className="subcribe-form mt-6 mb-3">
                            <form className="relative max-w-md mx-auto lg:ms-0">
                                <div className="relative">
                                    ...
                                    <input type="email" id="aiemail" name="email" className="pt-4 pe-40 pb-4 pl-10 w-full h-[50px] outline-none text-black dark:text-white rounded-lg bg-white/60 dark:bg-slate-900/60 shadow-sm dark:shadow-gray-800" placeholder="support@techwind.com"/>
                                </div>
