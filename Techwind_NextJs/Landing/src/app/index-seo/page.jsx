                       ...
                       <TextAnimation/>
                        ...
                        <div className="subcribe-form mt-6 mb-3">
                            <form className="relative max-w-xl mx-auto">
                                <input type="url" id="site-url" name="url" className="pt-4 pe-40 pb-4 ps-6 w-full h-[50px] outline-none text-black dark:text-white rounded-full bg-white/60 dark:bg-slate-900/60 shadow-sm dark:shadow-gray-800 border-gray-100  dark:border-gray-700" placeholder="http://www.yourdomain.com" />
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 mt-6 gap-[30px]">
                    {SeoServece.map((item,index)=>{
                        let Icons = item.icon
                        return(
                            <div key={index} className={`p-6 transition duration-500 rounded-2xl mt-6 ${item.class}`}>
                    ...
                    <div className="md:col-span-6">
                        <div className="relative lg:me-8">
                            ...
                            <div className="absolute bottom-24 end-0">
                                <Image src="/images/business/about02.jpg" width={0} height={0} sizes='100vw' style={{width:"192px", height:"auto"}}  className="rounded-md shadow-md w-48 h-48" alt="" />
                                <VideoModal/>
                            </div>
                        </div>
                    </div>
                                ...
                                <ul className="space-y-8" key={index}>
                                    <li className="rounded-lg shadow-lg dark:shadow-gray-800 p-6">
                                        <div className="flex items-center pb-6 border-b border-gray-100 dark:border-gray-800">
                                            <Image src={item.image} height={64} width={64} className="size-16 rounded-full shadow-sm dark:shadow-gray-800" alt="" />
                                    ...
                                    <li className="rounded-lg shadow-lg dark:shadow-gray-800 p-6">
                                        <div className="flex items-center pb-6 border-b border-gray-100 dark:border-gray-800">
                                            <Image src={item.image1} height={64} width={64} className="size-16 rounded-full shadow-sm dark:shadow-gray-800" alt="" />
