...
import AboutCounter from './componets/AboutUs/about-counter';
          ...
          <div className="relative grid lg:grid-cols-12 grid-cols-1 items-center mt-10 gap-[30px]">
              ...
              <div className="lg:me-6 lg:text-start text-center">
                <h1 className="font-semibold lg:leading-relaxed leading-relaxed text-3xl lg:text-5xl mb-6 text-gray-900 dark:text-white">
                  ...
                  <TypeAnimation
                    ...
                    wrapper="span"
                    speed={50}
                    className="typewrite bg-gradient-to-r from-indigo-600 to-purple-600 text-transparent bg-clip-text"
                    repeat={Infinity}
                  />
                  <span className="block text-3xl lg:text-5xl">Ecosystem</span>
                </h1>

                <p className="text-base max-w-xl lg:ms-0 mx-auto text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                  Unify affiliate management, campaign tracking, and partner analytics under one powerful dashboard. Track every click, optimize in real time, and boost ROI with precision.
                </p>
                ...
                <div className="flex items-center justify-center lg:justify-start mb-8">
                  <span className="text-sm text-gray-600 dark:text-gray-400">
                    Power smarter partnerships. Scale with confidence.
                  </span>
                </div>

                <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3">
                  <Link href="/free-trial" className="w-full sm:w-auto px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg transition-all duration-200 hover:shadow-sm text-sm">
                    Start Free Trial
                  </Link>

                  <button className="w-full sm:w-auto px-6 py-3 bg-white dark:bg-slate-800 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-medium rounded-lg transition-all duration-200 hover:bg-gray-50 dark:hover:bg-slate-700 hover:shadow-sm text-sm">
                    Book a Demo
                  </button>
                </div>
              </div>
            ...
            <div className="lg:col-span-5">
              <div className="relative after:content-[''] after:absolute lg:after:-top-0 after:-top-10 after:-right-32 after:size-[36rem] after:border-2 after:border-dashed after:border-slate-200 dark:after:border-slate-700 after:rounded-full after:animate-[spin_120s_linear_infinite] after:-z-1 before:content-[''] before:absolute lg:before:-top-24 before:-top-36 before:-right-56 before:w-[48rem] before:h-[48rem] before:border-2 before:border-dashed before:border-slate-200 dark:before:border-slate-700 before:rounded-full before:animate-[spin_240s_linear_infinite] before:-z-1">
                <div className="relative after:content-[''] after:absolute lg:after:-top-0 after:-top-10 after:-right-40 after:size-[36rem] after:bg-gradient-to-tl after:to-indigo-600/30 after:from-red-600/30 dark:after:to-indigo-600/50 dark:after:from-red-600/50 after:blur-[200px] after:rounded-full after:-z-1">
                  <Image src='/images/saas/light-dash.png' width={0} height={0} sizes='100vw' placeholder='blur' blurDataURL='/images/saas/light-dash.png' style={{ width: '1175px', height: 'auto' }} className="lg:max-w-none lg:ms-14" alt="TrackOG Dashboard Preview" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container relative">
          <div className="grid md:grid-cols-3 grid-cols-1 shadow-sm shadow-gray-300 dark:shadow-gray-500 rounded-lg md:divide-x-[1px] divide-y-[1px] divide-gray-200 dark:divide-gray-700">
            <div className="relative p-6 md:p-8">
              ...
              <i className="mdi mdi-account-search-outline absolute bottom-0 end-0 -z-1 opacity-5 text-9xl"></i>
            ...
            <div className="relative p-6 md:p-8">
              <i className="mdi mdi-wallet-outline bg-gradient-to-tl to-indigo-600 from-red-600 text-transparent bg-clip-text text-[45px]"></i>

              <h5 className="text-xl font-semibold my-5">Discribe Content</h5>

              <p className="text-slate-400">If the distribution of letters and words is random, the reader will not be distracted from making.</p>
              <i className="mdi mdi-wallet-outline absolute bottom-0 end-0 -z-1 opacity-5 text-9xl"></i>
            ...
            <div className="relative p-6 md:p-8">
              ...
              <p className="text-slate-400">If the distribution of letters and words is random, the reader will not be distracted from making.</p>
              <i className="mdi mdi-home-plus-outline absolute bottom-0 end-0 -z-1 opacity-5 text-9xl"></i>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px] relative">
            <div className="lg:col-span-8 md:col-span-12">
              <div className="grid grid-cols-1 pb-8">
                ...
                <p className="text-slate-400 max-w-xl">Launch your campaign and benefit from our expertise on designing and managing conversion centered Tailwind CSS v4.x html page.</p>
              </div>
              ...
              <div className="slide-track flex items-center">
                  ...
                  <ul className="space-y-4">
                    <li className="rounded-lg shadow-sm dark:shadow-gray-800 p-6 border-b-4 border-indigo-600">
                      <div className="flex items-center pb-6 border-b border-gray-200 dark:border-gray-800">
                        <Image src='/images/client/01.jpg' width={64} height={64} className="size-16 rounded-full shadow-sm dark:shadow-gray-800" alt="" />
                    ...
                    <li className="rounded-lg shadow-sm dark:shadow-gray-800 p-6 border-b-4 border-indigo-600">
                      <div className="flex items-center pb-6 border-b border-gray-200 dark:border-gray-800">
                        <Image src='/images/client/02.jpg' width={64} height={64} className="size-16 rounded-full shadow-sm dark:shadow-gray-800" alt="" />
                ...
                <div className="slide h-auto md:w-[360px] w-72 m-2">
                  <ul className="space-y-4">
                    ...
                    <li className="rounded-lg shadow-sm dark:shadow-gray-800 p-6 border-b-4 border-indigo-600">
                      <div className="flex items-center pb-6 border-b border-gray-200 dark:border-gray-800">
                        <Image src='/images/client/03.jpg' width={64} height={64} className="size-16 rounded-full shadow-sm dark:shadow-gray-800" alt="" />
                ...
                <div className="slide h-auto md:w-[360px] w-72 m-2">
                  <ul className="space-y-4">
                    <li className="rounded-lg shadow-sm dark:shadow-gray-800 p-6 border-b-4 border-indigo-600">
                      <div className="flex items-center pb-6 border-b border-gray-200 dark:border-gray-800">
                        <Image src='/images/client/04.jpg' width={64} height={64} className="size-16 rounded-full shadow-sm dark:shadow-gray-800" alt="" />
                    ...
                    <li className="rounded-lg shadow-sm dark:shadow-gray-800 p-6 border-b-4 border-indigo-600">
                      <div className="flex items-center pb-6 border-b border-gray-200 dark:border-gray-800">
                        <Image src='/images/client/05.jpg' width={64} height={64} className="size-16 rounded-full shadow-sm dark:shadow-gray-800" alt="" />
                ...
                <div className="slide h-auto md:w-[360px] w-72 m-2">
                  <ul className="space-y-4">
                    <li className="rounded-lg shadow-sm dark:shadow-gray-800 p-6 border-b-4 border-indigo-600">
                      <div className="flex items-center pb-6 border-b border-gray-200 dark:border-gray-800">
                        <Image src='/images/client/06.jpg' width={64} height={64} className="size-16 rounded-full shadow-sm dark:shadow-gray-800" alt="" />
                    ...
                    <li className="rounded-lg shadow-sm dark:shadow-gray-800 p-6 border-b-4 border-indigo-600">
                      <div className="flex items-center pb-6 border-b border-gray-200 dark:border-gray-800">
                        <Image src='/images/client/07.jpg' width={64} height={64} className="size-16 rounded-full shadow-sm dark:shadow-gray-800" alt="" />
                ...
                <div className="slide h-auto md:w-[360px] w-72 m-2">
                  <ul className="space-y-4">
                    <li className="rounded-lg shadow-sm dark:shadow-gray-800 p-6 border-b-4 border-indigo-600">
                      <div className="flex items-center pb-6 border-b border-gray-200 dark:border-gray-800">
                        <Image src='/images/client/08.jpg' width={64} height={64} className="size-16 rounded-full shadow-sm dark:shadow-gray-800" alt="" />
        ...
        {/* <div className="container relative md:mt-24 mt-16">
          ...
          <div className="grid grid-cols-1 mt-8 gap-[30px]">
            {priceData.map((item, index) => {
              return (
                <div className="group md:flex items-center justify-between p-6 rounded-lg shadow-sm dark:shadow-gray-700" key={index}>
