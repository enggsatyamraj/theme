                                ...
                                <div className="registration-form relative text-dark text-start">
                                    <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-0 gap-6 lg:divide-x-[1px] lg:divide-gray-200 lg:dark:divide-gray-700">
                                        <div className="filter-search-form relative">
                                            ...
                                            <input name="name" type="text" id="location" className="form-input lg:rounded-t-sm lg:rounded-e-none lg:rounded-b-none lg:rounded-s-sm lg:outline-0 w-full filter-input-box bg-gray-50 dark:bg-slate-800 border-0 focus:ring-0 ps-10" placeholder="Location"/>
                                        </div>

                                        <div className="filter-search-form relative">
                                            <TbCurrencyDollar className="absolute top-[48%] -translate-y-1/2 start-3 z-1 text-indigo-600 text-[20px]"/>
                                            <i ></i>
                                            <input name="name" type="number" id="job-keyword" className="form-input lg:rounded-t-sm lg:rounded-e-none lg:rounded-b-none lg:rounded-s-sm lg:outline-0 w-full filter-input-box bg-gray-50 dark:bg-slate-800 border-0 focus:ring-0 ps-10" placeholder="Budget"/>
                                        </div>
                                    
                                        <div className="filter-search-form relative">
                                            <LuCalendarDays className="absolute top-[48%] -translate-y-1/2 start-3 z-1 text-indigo-600 text-[20px]"/>
                                            <input name="name" type="text" id="job-keyword" className="form-input lg:rounded-t-sm lg:rounded-e-none lg:rounded-b-none lg:rounded-s-sm lg:outline-0 w-full filter-input-box bg-gray-50 dark:bg-slate-800 border-0 focus:ring-0 start ps-10" placeholder="Select date"/>
                                        </div>
        ...
        <div className="container relative">
            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                {travelBenefit.map((item,index)=>{
                    let Icons = item.icon
                    return(
                        <div key={index} className="group p-6 rounded-lg shadow-sm dark:shadow-gray-800 bg-white dark:bg-slate-900 hover:-translate-y-2 duration-500">
                            <div
                                className="w-16 h-16 bg-indigo-600/5 group-hover:bg-indigo-600 group-hover:text-white border-2 border-indigo-600/20 text-indigo-600 rounded-lg text-2xl flex align-middle justify-center items-center shadow-xs dark:shadow-gray-800 duration-500">
                                <Icons/>
                            </div>
        ...
        <div className="container relative md:mt-24 mt-16">
            ...
            <div className="relative grid md:grid-cols-12 grid-cols-1 items-center mt-8 gap-[30px]">
                <div className="md:col-span-6">
                    <Image src='/images/travel/7.jpg' width={0} height={0} sizes='100vw' style={{width:'100%', height:'auto'}} placeholder='blur' blurDataURL='/images/travel/7.jpg' className="rounded-md shadow-sm dark:shadow-gray-800" alt=""/>
                </div>
