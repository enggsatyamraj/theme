                ...
                <div className="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 items-center mt-10 gap-[30px]">
                    ...
                    <div className="lg:col-span-5 relative">
                        ...
                        <div className="absolute -top-4 start-1/2 -translate-x-1/2 text-center">
                            <Link href="#!" onClick={() => setOpen(true)}  className="lightbox size-20 rounded-full shadow-md dark:shadow-gyay-700 inline-flex items-center justify-center text-white bg-indigo-600">
