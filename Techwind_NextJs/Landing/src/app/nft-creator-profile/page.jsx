...
export default function Page(){
    ...
    return(
        ...
        <section className="relative md:pb-24 pb-16 lg:mt-24 mt-[74px]">
            <div className="container relative lg:!px-3 !px-0">
                <div className="group profile-banner relative overflow-hidden text-transparent lg:rounded-xl shadow-sm dark:shadow-gray-700">
                    <input id="pro-banner" name="profile-banner" type="file" className="hidden"/>
                    <div className="relative shrink-0">
                        <Image src="/images/blog/slide02.jpg" width={0} height={0} sizes='100vw' style={{width:"100%", height:"320px"}} className="h-80 w-full object-cover" id="profile-banner" alt="" />
                    ...
                    <div className="md:w-full">
                        <div className="relative -mt-[60px] text-center">
                            <div className="group profile-pic w-[112px] mx-auto">
                                ...
                                <div>
                                    <div className="relative size-28 mx-auto rounded-full shadow-sm dark:shadow-gray-800 ring-4 ring-slate-50 dark:ring-slate-800 overflow-hidden">
                            ...
                            <div className="mt-6">
                                ...
                                <div className="mt-4 space-x-1">
                                    ...
                                    <Link href="#" className="size-8 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center rounded-full bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white"><i className="mdi mdi-account-plus"></i></Link>
                                    <Link href="/nft-creator-profile-edit" className="size-8 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center rounded-full bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white"><i className="mdi mdi-cog"></i></Link>
                                </div>
                            </div>
                        </div>
                    </div>
