                    ...
                    <div className="lg:col-span-5 md:col-span-6">
                        <div className="relative">
                            ...
                            <div className="absolute -end-5 -bottom-16">
                                <Image width={0} height={0} sizes='100vw' style={{width:"280px", height:"auto"}} src="/images/hotel/ab2.jpg" className="rounded-full lg:w-[280px] w-[200px] border-8 border-white dark:border-slate-900" alt="" />
                            </div>
                        </div>
                    </div>
