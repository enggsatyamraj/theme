                    ...
                    <div className="lg:col-span-5 md:col-span-6">
                        <div className="relative">
                            ...
                            <div className="absolute -end-5 -bottom-16">
                                <Image src="/images/law/ab2.jpg" width={0} height={0} sizes='100vw' style={{width:"280px" , height:"auto"}} className="lg:w-[280px] w-[200px] border-8 border-white dark:border-slate-900" alt="" />
                            </div>
                        </div>
                    </div>
