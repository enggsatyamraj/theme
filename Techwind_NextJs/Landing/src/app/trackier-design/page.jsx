...
export default function TrackierDesignPage() {
    ...
    const faqData = [
        {
            question: "How can TrackOG help improve an Ecommerce affiliate marketing campaign's ROI?",
            answer: "TrackOG provides comprehensive tracking and analytics, allowing you to see which marketing channels (like social media, search ads, or email) are driving the most valuable sales. This helps you optimize spending and maximize ROI."
        },
        {
            question: "Does TrackOG offer any specific features for mobile Ecommerce?",
            answer: "Yes, TrackOG can track mobile app installs, in-app purchases, and other mobile-specific metrics, giving you a complete view of your mobile E-commerce performance."
        },
        {
        ...
        {
            question: "What kind of reports can be generated with TrackOG for an Ecommerce campaign?",
            answer: "TrackOG generates comprehensive reports including revenue tracking, conversion analysis, traffic source performance, affiliate performance metrics, and custom KPI dashboards."
        },
        {
            question: "How does TrackOG handle attribution for Ecommerce sales?",
            answer: "TrackOG uses advanced attribution models to accurately track the customer journey across multiple touchpoints, ensuring proper credit assignment to marketing channels."
        },
        {
            question: "Can TrackOG track product-specific performance within an Ecommerce store?",
            answer: "Yes, TrackOG can track individual product performance, helping you understand which products drive the most revenue and optimize your marketing accordingly."
        },
        {
            question: "How does TrackOG protect Ecommerce campaigns from fraud?",
            answer: "TrackOG includes built-in fraud detection that identifies suspicious traffic patterns, click fraud, and invalid conversions to protect your advertising spend."
        },
        {
            question: "Can TrackOG integrate with an Ecommerce platform (e.g., Shopify, WooCommerce)?",
            answer: "Yes, TrackOG offers seamless integrations with major ecommerce platforms including Shopify, WooCommerce, Magento, and many others."
        },
        {
            question: "How does TrackOG ensure data privacy and security for customer data?",
            answer: "TrackOG follows strict data privacy protocols and compliance standards to ensure all customer data is handled securely and in accordance with regulations."
        }
    ];
                    ...
                    <div className="grid lg:grid-cols-2 items-center gap-12">
                        <div>
                            ...
                            <h1 className="text-4xl lg:text-5xl font-normal text-gray-800 mb-6 leading-tight">
                                TrackOG for <span className="text-green-500 font-medium">Ecommerce<br />
                    ...
                    <div className="grid lg:grid-cols-2 items-center gap-16">
                        ...
                        <div>
                            <h3 className="text-2xl lg:text-3xl font-normal text-gray-800 mb-6 leading-tight">
                                ...
                                with TrackOG's Real-Time Analytics
                            </h3>

                            <p className="text-base text-gray-600 mb-8 leading-relaxed">
                                TrackOG provides up-to-the-minute data on key metrics like
                    ...
                    <div className="grid lg:grid-cols-2 items-center gap-16">
                        ...
                        <div>
                            <h3 className="text-2xl lg:text-3xl font-normal text-gray-800 mb-6 leading-tight">
                                ...
                                with TrackOG's Fraud Shields
                            </h3>

                            <p className="text-base text-gray-600 mb-8 leading-relaxed">
                                Fraud or malware can harm any e-commerce business.
                                TrackOG's fraud shields and anti-fraud tools detect and block
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="bg-blue-50 border border-blue-100 rounded-lg p-4">
                                    <div className="text-sm font-medium text-blue-800 mb-1">Experience Peace of Mind, with TrackOG</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-16 bg-yellow-50">
                <div className="container mx-auto px-4">
                    <div className="grid lg:grid-cols-2 items-center gap-12">
                        <div>
                            <h3 className="text-2xl lg:text-3xl font-normal text-gray-800 mb-6 leading-tight">
                                See How <span className="text-gray-700 font-medium">TrackOG's Marketing Analytics</span><br />
                    ...
                    <div className="grid lg:grid-cols-2 items-center gap-16">
                        <div>
                            ...
                            <p className="text-base text-gray-600 mb-8 leading-relaxed">
                                ...
                                TrackOG's in-depth reporting. Customize reports to track
                    ...
                    <div className="grid lg:grid-cols-2 items-center gap-16">
                        ...
                        <div>
                            <h3 className="text-2xl lg:text-3xl font-normal text-gray-800 mb-6 leading-tight">
                                ...
                                with TrackOG's Two-Way APIs
                            </h3>

                            <p className="text-base text-gray-600 mb-8 leading-relaxed">
                                Streamline your workflow with TrackOG's seamless e-
