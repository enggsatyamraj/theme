                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center">
                        ...
                        <Link href="" className="ms-1">
                            ...
                            <span className="size-10 items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-md border bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white sm:hidden inline-flex"><BiExport className=""/></span>
                        </Link>
                    </div>
                </div>
                                    ...
                                    <div className="relative overflow-hidden rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900" key={index}>
                                        <div className="p-5">
                                            <div className="flex items-center justify-between mb-3">
                                                <div className="flex items-center">
                                                    <span className="flex justify-center items-center rounded-md size-8 min-w-[32px] bg-indigo-600/5 dark:bg-indigo-600/10 shadow-sm shadow-indigo-600/5 dark:shadow-indigo-600/10 text-indigo-600">
                        ...
                        <div className="relative overflow-hidden rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900">
                            ...
                            <SimpleBar className="h-[352px]" data-simplebar>
                                <table className="w-full text-start">
                                    ...
                                    <tbody>
                                        {recentOrder.map((item:RecentOrder,index:number)=>{
                                            return(
                    ...
                    <div className="lg:col-span-4">
                        <div className="relative overflow-hidden rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900">
                            <div className="p-4 flex items-center justify-between border-b border-gray-100 dark:border-gray-800">
                                ...
                                <div className="position-relative">
                                    <select className="form-select form-input w-full py-2 px-2 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-100 focus:border-gray-200 dark:border-gray-800 dark:focus:border-gray-700 focus:ring-0" id="yearchart">
                                        <option value="T">Today</option>
                                        <option value="W">This Week</option>
                                        <option value="M">This Month</option>
                                        <option value="Y">This Year</option>
                            ...
                            <SimpleBar className="h-[340px]" data-simplebar>
                                <table className="w-full text-start">
                                    ...
                                    <tbody>
                                        {topProduct.map((item:TopProduct,index:number)=>{
                                            return(
                                                <tr className="border-t border-gray-100 dark:border-gray-800" key={index}>
                                                    <td className="px-4 py-3 text-start">
                                                        <span className="flex items-center">
                        ...
                        <div className="relative overflow-hidden rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900">
                            ...
                            <SimpleBar className="h-[340px]" data-simplebar>
                                <table className="w-full text-start">
                                    ...
                                    <tbody>
                                        {topSeller.map((item:TopSeller,index:number)=>{
                                            return(
                                                <tr className="border-t border-gray-100 dark:border-gray-800" key={index}>
                                                    <td className="px-4 py-3 text-start">
                                                        <Link href="" className="flex items-center hover:text-indigo-600">
                                                    ...
                                                    <td className="px-4 py-3 text-center">
                                                        <div>
                                                            {item.category.map((el,index)=>{
                                                                return(
                                                                    <Link href="#" className="bg-indigo-600 hover:bg-indigo-700 text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ms-1" key={index}>{el}</Link>
                                                                )
                                                            })}
                                                        </div>
                                                    </td>
