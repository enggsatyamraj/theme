...
export default function Page() {
  let [isOpen, setOpen] = useState<number>(0)
  let [isOpen1, setOpen1] = useState<number>(0)
  ...
  let handleTabClick1 = (index:number) => {
      setOpen1(index);
  };

  let [manu1, setManu1] = useState(false)
  let [manu2, setManu2] = useState(false)
  let [manu3, setManu3] = useState(false)
  let [manu4, setManu4] = useState(false)
  let [manu5, setManu5] = useState(false)
  let [manu6, setManu6] = useState(false)
  let [manu7, setManu7] = useState(false)
  let [manu8, setManu8] = useState(false)
  let [manu9, setManu9] = useState(false)
  let [manu10, setManu10] = useState(false)
  let [manu11, setManu11] = useState(false)
  let [manu12, setManu12] = useState(false)
  let [manu13, setManu13] = useState(false)
  let [manu14, setManu14] = useState(false)
  let [manu15, setManu15] = useState(false)
  let [manu16, setManu16] = useState(false)
  let [manu17, setManu17] = useState(false)
  let [manu18, setManu18] = useState(false)
  let [manu19, setManu19] = useState(false)
  let [manu20, setManu20] = useState(false)
  ...
  useEffect(()=>{
      ...
      return()=>{
        ...
        document.removeEventListener("mousedown", handleClick3);
        document.removeEventListener("mousedown", handleClick4);
        document.removeEventListener("mousedown", handleClick5);
        document.removeEventListener("mousedown", handleClick6);
        document.removeEventListener("mousedown", handleClick7);
        document.removeEventListener("mousedown", handleClick8);
        document.removeEventListener("mousedown", handleClick9);
        document.removeEventListener("mousedown", handleClick10);
        document.removeEventListener("mousedown", handleClick11);
        document.removeEventListener("mousedown", handleClick12);
        document.removeEventListener("mousedown", handleClick13);
        document.removeEventListener("mousedown", handleClick14);
        document.removeEventListener("mousedown", handleClick15);
        document.removeEventListener("mousedown", handleClick16);
        document.removeEventListener("mousedown", handleClick17);
        document.removeEventListener("mousedown", handleClick18);
        document.removeEventListener("mousedown", handleClick19);
        document.removeEventListener("mousedown", handleClick20);
      }
  },[])
                    ...
                    <div className="xl:col-span-3 md:col-span-4">
                        <div className="rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900 p-6 sticky top-20">
                            <ul className="list-none sidebar-nav mb-0 py-0" id="navmenu-nav">
                                <li className="navbar-item p-0"><Link href="#buttons" className="text-base font-medium navbar-link">UI Buttons</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link href="#badges" className="text-base font-medium navbar-link">UI Badges</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link href="#alerts" className="text-base font-medium navbar-link">UI Alerts</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link href="#dropdowns" className="text-base font-medium navbar-link">UI Dropdowns</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link href="#text-colors" className="text-base font-medium navbar-link">UI Text Colors</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link href="#backgrounds" className="text-base font-medium navbar-link">UI Background Colors</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link href="#accordions" className="text-base font-medium navbar-link">UI Accordions Colors</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link href="#nav-tabs" className="text-base font-medium navbar-link">UI Nav Tabs</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link href="#form-inputs" className="text-base font-medium navbar-link">UI Form Elements</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link href="#shadows" className="text-base font-medium navbar-link">UI Shadow</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link href="#borders" className="text-base font-medium navbar-link">UI Borders</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link href="#breadcrumbs" className="text-base font-medium navbar-link">UI Breadcrumbs</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link href="#paginations" className="text-base font-medium navbar-link">UI Paginations</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link href="#modals" className="text-base font-medium navbar-link">UI Modals</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link href="#tables" className="text-base font-medium navbar-link">UI Tables</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link href="#headings" className="text-base font-medium navbar-link">UI Headings</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link href="#font-weights" className="text-base font-medium navbar-link">UI Font Weights</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link href="#icons" className="text-base font-medium navbar-link">UI Icons</Link></li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div className="" id="backgrounds">
                                ...
                                <div className="grid grid-cols-1 gap-[30px]">
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 text-white bg-indigo-600">.bg-indigo-600</li>
                                    ...
                                    <div className="shadow-sm dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-indigo-600">.bg-indigo-600</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-indigo-600/95">.bg-indigo-600 .opacity-95</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-indigo-600/90">.bg-indigo-600 .opacity-90</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-indigo-600/80">.bg-indigo-600 .opacity-80</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-indigo-600/75">.bg-indigo-600 .opacity-75</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-indigo-600/70">.bg-indigo-600 .opacity-70</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-indigo-600/60">.bg-indigo-600 .opacity-60</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-indigo-600/50">.bg-indigo-600 .opacity-50</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-indigo-600/40">.bg-indigo-600 .opacity-40</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-indigo-600/30">.bg-indigo-600 .opacity-30</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-indigo-600/25">.bg-indigo-600 .opacity-25</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-indigo-600/20">.bg-indigo-600 .opacity-20</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-indigo-600/10">.bg-indigo-600 .opacity-10</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-indigo-600/5">.bg-indigo-600 .opacity-5</li>
                                                <li className="inline-block shadow-sm dark:shadow-gray-800 rounded-md py-2 px-3 m-0.5 bg-indigo-600/0">.bg-indigo-600 .opacity-0</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <form>
                                                <div className="grid grid-cols-1 gap-5">
                                                    <div className="">
                                                        ...
                                                        <input type="text" className="form-input w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 mt-2" placeholder="First Name:" id="firstname" name="name"/>
                                                    </div>
                                                    ...
                                                    <div className="">
                                                        ...
                                                        <input type="email" className="form-input w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 mt-2" placeholder="Email" name="email"/>
                                                    </div>
                                                    ...
                                                    <div className="">
                                                        ...
                                                        <input type="number" className="form-input w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0 mt-2" placeholder="Zip:" id="zipcode" name="number"/>
                                                    </div>
                                                    ...
                                                    <div className="">
                                                        ...
                                                        <div className="flex items-center w-full mb-0">
                                                            <input className="form-checkbox size-4 appearance-none rounded border border-gray-200 dark:border-gray-800 accent-indigo-600 checked:appearance-auto dark:accent-indigo-600 focus:border-indigo-300 focus:ring-0 focus:ring-offset-0 focus:ring-indigo-200 focus:ring-opacity-50 me-2" type="checkbox" defaultChecked value="" id="sameaddress"/>
