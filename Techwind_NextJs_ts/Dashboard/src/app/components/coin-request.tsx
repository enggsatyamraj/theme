...
export default function CoinRequest(){
    ...
    return(
        <>
        <Link href="#" className="py-[5px] px-4 inline-block font-semibold tracking-wide align-middle duration-500 text-sm text-center bg-red-600 hover:bg-red-700 border-red-600 hover:border-red-700 text-white rounded-md" onClick={openModal}>Request</Link>

        <div className={`${open === true ? '' : 'hidden'} fixed z-999  overflow-hidden inset-0 m-auto flex justify-center items-center bg-slate-900/70`} >
            <div className="relative w-full h-auto max-w-xl p-4">
                <div className="relative bg-white dark:bg-slate-900 rounded-lg shadow-sm dark:shadow-gray-700">
                            ...
                            <div className="grid grid-cols-12 gap-3">
                                ...
                                <div className="col-span-12">
                                    ...
                                    <div className="relative mt-2">
                                        <Link href="" className="absolute top-0.5 end-0.5 size-9 text-xl bg-gray-100 dark:bg-slate-800 inline-flex justify-center items-center text-dark dark:text-white rounded" id="QUcode"><i className="uil uil-copy"></i></Link>
                                        <input type="text" className="form-input pe-12 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0" defaultValue="c12b001a15f9bd46ef1c6551386c" required/>
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <div className="text-end p-4 border-t border-gray-100 dark:border-gray-700">
                        <Link href="#" className="py-[5px] px-4 inline-block font-semibold tracking-wide align-middle duration-500 text-sm text-center bg-emerald-600 hover:bg-emerald-700 border-emerald-600 hover:border-emerald-700 text-white rounded-md" onClick={openModal}>Done</Link>
                    </div>
                </div>
            </div>
        </div>
