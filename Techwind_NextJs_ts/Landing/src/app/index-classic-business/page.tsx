                    ...
                    <div className="lg:col-span-5 md:col-span-6">
                        <div className="relative">
                            <div className="relative flex justify-end">
                                <Image src="/images/business/about01.jpg" width={0} height={0} sizes="100vw" className="lg:w-[400px] w-[280px] rounded shadow-sm dark:shadow-gray-700" alt=""/>
                                <VideoModalFive/>
                            </div>
                            <div className="absolute md:-start-5 start-0 -bottom-16">
                                <Image src="/images/business/about02.jpg" width={0} height={0} sizes="100vw" className="lg:w-[280px] w-[200px] border-8 border-white dark:border-slate-900 rounded" alt=""/>
                            </div>
                        </div>
                    </div>
