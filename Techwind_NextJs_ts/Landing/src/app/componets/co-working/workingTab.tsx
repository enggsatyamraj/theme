...
export default function WorkingTab(){
            ...
            <div className="container relative">
                <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                    ...
                    <div className="lg:col-span-8 md:col-span-7">
                        ...
                        {
                                coworkTab.map((item:WorkData, index:number) =>{
                                    return (
                                        <div className={`${isOpenTab === index  ? '': 'hidden'}`} id="profile" role="tabpanel" aria-labelledby="profile-tab" key={index}>
                                            <Image src={item.image} width={0} height={0} sizes='100vw' style={{width:"100%", height:"auto"}} className="shadow-sm rounded-md" alt="" />
                                            <div className="mt-6">
