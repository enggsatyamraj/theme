        ...
        <div className="container relative">
            ...
            <div className="container relative mt-8">
                <div id="grid" className="grid lg:grid-cols-5 md:grid-cols-5 sm:grid-cols-5 grid-cols-5 mt-4 gap-[30px]">
                    {
                        filteredData.map((data:RestaurentData, index:number) => {
                            return (
                                <div className="group picture-item p-3 mt-6" data-groups="['break']" key={index}>
                                    <Image src={data.image} width={0} height={0} sizes='100vw' style={{width:"100%", height:"auto"}} className="rounded-full size-32 mx-auto group-hover:animate-[spin_10s_linear_infinite]" alt="" />
