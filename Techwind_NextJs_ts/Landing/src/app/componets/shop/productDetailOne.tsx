...
export default function ProductDetail(){
    ...
    const [isOpenTab, setisOpen] = useState<number>(0);

    const handleTabClick = (index:number) => {
        setisOpen(index);
    };
    const handleStepDown = (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
        const button = e.target as HTMLElement; // Cast target to HTMLElement
        ...
        <>
                            ...
                            <TinySlider settings={settings}>
                                {services.map((item:Services, index:number) => (
                                    <div className="tiny-slide" key={index}>
                                        <Image src={item.image} width={0} height={0} sizes='100vw' style={{width:"100%", height:"auto"}} className="rounded-md shadow-sm dark:shadow-gray-800" alt="" />
                                    </div>
                                ))}
                            </TinySlider>
                        </div>
                            ...
                            <div className="grid lg:grid-cols-2 grid-cols-1 gap-[30px] mt-4">
                                <div className="flex items-center">
                                    ...
                                    <div className="space-x-1">
                                        <Link href="#" className="size-9 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center rounded-md bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white">S</Link>
                                        <Link href="#" className="size-9 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center rounded-md bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white">M</Link>
                                        <Link href="#" className="size-9 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center rounded-md bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white">L</Link>
                                        <Link href="#" className="size-9 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center rounded-md bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white">XL</Link>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div className="qty-icons ms-3 space-x-1">
                                        <button onClick={(e)=>handleStepDown(e)} className="size-9 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center rounded-md bg-indigo-600/5 hover:bg-indigo-600 border border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white minus"                                            >
                                            -
                                        </button>
                                        ...
                                        <button onClick={(e)=>handleStepUp(e)} className="size-9 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center rounded-md bg-indigo-600/5 hover:bg-indigo-600 border border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white plus" >
                                            +
                                        </button>
                                    </div>
                                </div>
                ...
                <div className="grid md:grid-cols-12 grid-cols-1 mt-10 gap-[30px]">
                    ...
                    <div className="lg:col-span-9 md:col-span-7">
                        <div id="" className=" p-6 bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800 rounded-md">
                            ...
                            {isOpenTab === 2 ?
                                ...
                                {
                                    shopItem.map((data:ShopItem,index:number) => {
                                        return (
                                        <div className={data.class} key={index}>
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center">
                                                    <Image src={data.image} width={44} height={44} className="size-11 rounded-full shadow-sm" alt="" />
