...
export default function PricingTab(){
    const [isOpenTab, setisOpenTab] = useState<number>(0);
                        ...
                        {isOpenTab === 0 ?
                            <div>
                                <div className="grid lg:grid-cols-4 md:grid-cols-2 mt-8 gap-[30px]">
                                    ...
                                    <div className="group border-b-[3px] border-indigo-600 p-6 py-8 transition-all duration-500 ease-in-out hover:scale-105 relative overflow-hidden shadow-sm dark:shadow-gray-800 rounded-md bg-white dark:bg-slate-900 h-fit">
