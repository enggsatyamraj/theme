        ...
        <div className="container relative">
            ...
            <div id="navigation" style={{ display: isMenu ? 'block' : 'none' }}>
                <ul className="navigation-menu justify-end" id="navmenu-nav">
                    <li className="has-submenu cursor-pointer">
                        <Link1 to="home"  activeClass="active" smooth={true} duration={500} spy={true} className="sub-menu-item">Home</Link1>
                    
                    </li>
                    <li className="has-submenu cursor-pointer">
                        <Link1 activeClass="active" to="features" smooth={true} duration={500} spy={true} className="sub-menu-item">Feature</Link1>
                    </li>
                    <li className="has-submenu cursor-pointer">
                        <Link1 activeClass="active" to="pricing" smooth={true} duration={500} spy={true} className="sub-menu-item">Price</Link1>
                    </li>
                    <li className="has-submenu cursor-pointer">
                        <Link1 activeClass="active" to="team" smooth={true} duration={500} spy={true} className="sub-menu-item">Team</Link1>
                    </li>
                    <li className="has-submenu cursor-pointer">
                        <Link1 activeClass="active" to="review" smooth={true} duration={500} spy={true} className="sub-menu-item">Review</Link1>
                    </li>
                    <li className="has-submenu cursor-pointer">
                        <Link1 activeClass="active" to="blog" smooth={true} duration={500} spy={true} className="sub-menu-item">Blog</Link1>
                    </li>
                    <li className="has-submenu cursor-pointer">
