                ...
                <ul className={`navigation-menu ${navClass} ${navJustify}`}>
                        ...
                        <ul className="submenu megamenu">
                            <li>
                                <ul>
                                    ...
                                    <li className={manu === "/index-web-programming" || "" ? "active" : ""}><Link href="/index-web-programming" className="sub-menu-item">Web Programming</Link></li>
                            ...
                            <li>
                                <ul>
                                    ...
                                    <li className={manu === "/index-cleaner" || "" ? "active" : ""}><Link href="/index-cleaner" className="sub-menu-item">Cleaner Service </Link></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <ul>
                                    ...
                                    <li className={manu === "/index-solar" || "" ? "active" : ""}><Link href="/index-solar" className="sub-menu-item">Solar / Green Energy <span className="bg-yellow-500 inline-block text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ms-1">New</span></Link></li>
                    ...
                    <li className={`${["/page-aboutus", "/page-services","/page-team", "/page-pricing","/page-testimonial","/user-profile","/user-billing","/user-payment","/user-invoice","/user-notification","/user-setting","/property-listing","/property-detail","/course-listing","/course-detail","/nft-explore","/nft-auction","/nft-collection","/nft-creators","/nft-creator-profile","/nft-creator-profile-edit","/nft-wallet","/nft-create-item","/nft-detail","/food-recipe","/shop-grid","/shop-grid","/shop-grid-two","/shop-item-detail","/shop-cart","/shop-checkout","/food-recipe","/shop-grid","/shop-grid-two","/shop-item-detail","/shop-cart","/shop-checkout","/shop-account","/food-recipe","/shop-grid","/shop-grid-two","/shop-item-detail","/shop-cart","/shop-checkout","/shop-account","/photography-about","/photography-portfolio","/page-job-grid","/page-job-detail","/page-job-apply","/page-job-post","/page-job-career","/page-job-candidates","/page-job-candidate-detail","/page-job-companies","/page-job-company-detail","/forums-topic","/forums-comments","/helpcenter","/helpcenter-faqs","/helpcenter-guides","/helpcenter-support","/blog","/blog-sidebar","/blog-detail","/blog-standard-post","/blog-slider-post","/blog-gallery-post","/blog-youtube-post","/blog-vimeo-post","/blog-audio-post","/blog-blockquote-post","/blog-left-sidebar-post","/email-confirmation","/email-password-reset","/email-alert","/email-invoice","/auth-login","/auth-signup","/auth-re-password","/auth-lock-screen","/page-terms","/page-privacy","/page-comingsoon","/page-maintenance","/page-error","/page-thankyou","/contact-detail","/contact-one","/contact-two","/page-services","/page-service-detail"].includes(manu)? "active" : ""} has-submenu parent-parent-menu-item`}>
                        ...
                        <ul className="submenu">
                            <li className={`${["/page-aboutus", "/page-services","/page-service-detail","/page-team", "/page-pricing", "/page-testimonial"].includes(manu)? "active" : ""} has-submenu parent-menu-item`}><Link href="#"> Company </Link><span className="submenu-arrow"></span>
                                <ul className="submenu">
                                    <li className={manu === "/page-aboutus" || "" ? "active" : ""}><Link href="/page-aboutus" className="sub-menu-item"> About Us</Link></li>
                                    <li className={`has-submenu child-menu-item ${["/page-services","/page-service-detail"].includes(manu)? "active" : ""}`}><Link href="#"> Services </Link><span className="submenu-arrow"></span>
                                        <ul className="submenu">
                                            <li className={manu === "/page-services" || "" ? "active" : ""}><Link href="/page-services" className="sub-menu-item">Services</Link></li>
                                            <li className={manu === "/page-service-detail" || "" ? "active" : ""}><Link href="/page-service-detail" className="sub-menu-item">Service Detail </Link></li>
                                        </ul>  
                                    </li>
                            ...
                            <li className={`${["/helpcenter", "/helpcenter-faqs","/helpcenter-guides","/helpcenter-support"].includes(manu)? "active" : ""} has-submenu parent-menu-item`}><Link href="#"> Helpcenter </Link><span className="submenu-arrow"></span>
                                <ul className="submenu">
                                    <li className={manu === "/helpcenter" || "" ? "active" : ""}><Link href="/helpcenter" className="sub-menu-item">Overview</Link></li>
