                                            ...
                                            <div className="grid grid-cols-1">
                                                <div className="foot-subscribe my-3">
                                                    ...
                                                    <div className="form-icon relative mt-2">
                                                        ...
                                                        <input type="email" className="form-input ps-12 rounded w-full py-2 px-3 h-10 bg-gray-800 dark:bg-gray-700 border-0 text-gray-100 focus:shadow-none focus:ring-0" placeholder="Email" name="email"/>
                                                    </div>
                                                </div>
