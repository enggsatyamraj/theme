                ...
                <div className="grid grid-cols-1 mt-10 text-center">
                    ...
                    <div className="subcribe-form mt-6">
                        <form className="relative max-w-xl mx-auto">
                            <input type="text" id="SearchForumKeyword" name="text" className="pt-4 pe-40 pb-4 ps-6 w-full h-[50px] outline-none text-black dark:text-white rounded-full bg-white/70 dark:bg-slate-900/70 border border-gray-100 dark:border-gray-800" placeholder="Enter your keywords :" />
                    ...
                    <div className="lg:col-span-8">
                        <div className="relative overflow-x-auto block w-full bg-white dark:bg-slate-900 rounded-md border border-gray-100 dark:border-slate-800">
                            <table className="w-full text-start">
                                ...
                                <tbody>
                                    {forumData.map((item:ForumData,index:number)=>{
                                        return(
