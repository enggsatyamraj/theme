        ...
        <section className="relative md:py-24 py-16">
            <div className="container relative">
                <div className="flex justify-center">
                    <div className="relative z-2 transition-all duration-500 ease-in-out sm:-mt-[200px] -mt-[140px] m-0 lg:w-10/12 bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800 rounded-md p-6">
                        <div className="grid md:grid-cols-3 grid-cols-1 gap-[24px]">
                            <div>
                                <div
                                    className="w-16 h-16 bg-indigo-600/5 text-indigo-600 rounded-lg text-2xl flex align-middle justify-center items-center shadow-xs dark:shadow-gray-800">
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 mt-8 gap-[30px]">
                    {hospitalServices.map((item:Services,index:number)=>{
                        let Icons = item.icon
                        return(
                            <div className="text-center md:px-6" key={index}>
                                <div className="w-20 h-20 bg-indigo-600/5 text-indigo-600 rounded-3xl text-3xl flex align-middle justify-center items-center shadow-xs dark:shadow-gray-800 mx-auto">
                    ...
                    <div className="relative overflow-x-auto block w-full bg-white dark:bg-slate-900">
                        <table className="w-full text-sm text-start">
                            <thead
                                className="text-lg">
                                <tr>
                                    <th className="text-center border border-gray-100 dark:border-gray-800 py-6 min-w-[120px]">Time Table</th>
                                    <th className="text-center border border-gray-100 dark:border-gray-800 py-6 min-w-[200px]">Monday</th>
                                    <th className="text-center border border-gray-100 dark:border-gray-800 py-6 min-w-[200px]">Tuesday</th>
                                    <th className="text-center border border-gray-100 dark:border-gray-800 py-6 min-w-[200px]">Wednesday</th>
                                    <th className="text-center border border-gray-100 dark:border-gray-800 py-6 min-w-[200px]">Thursday</th>
                                    <th className="text-center border border-gray-100 dark:border-gray-800 py-6 min-w-[200px]">Friday</th>
                                    <th className="text-center border border-gray-100 dark:border-gray-800 py-6 min-w-[200px]">Saturday</th>
                                    <th className="text-center border border-gray-100 dark:border-gray-800 py-6 min-w-[200px]">Sunday</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <th className="text-center border border-gray-100 dark:border-gray-800 py-5">09:00AM</th>
                                    <td className="p-3 border border-gray-100 dark:border-gray-800">
                                        <div className="flex items-center mb-3">
                                            <Image src="/images/client/01.jpg" width={48} height={48} className="size-12 rounded-full shadow-sm" alt="" />
                                            <div className="ms-3">
                                    ...
                                    <td className="p-3 border border-gray-100 dark:border-gray-800">
                                        <div className="flex items-center mb-3">
                                            <Image src="/images/client/03.jpg" width={46} height={46} className="size-12 rounded-full shadow-sm" alt="" />
                                            <div className="ms-3">
                                ...
                                <tr>
                                    <th className="text-center border border-gray-100 dark:border-gray-800 py-5">11:00AM</th>
                                    <td className="border border-gray-100 dark:border-gray-800"></td>
                                    <td className="p-3 border border-gray-100 dark:border-gray-800">
                                        <div className="flex items-center mb-3">
                                            <Image src="/images/client/02.jpg" width={46} height={46} className="size-12 rounded-full shadow-sm" alt="" />
                                            <div className="ms-3">
                                    ...
                                    <td className="p-3 border border-gray-100 dark:border-gray-800">
                                        <div className="flex items-center mb-3">
                                            <Image src="/images/client/05.jpg" width={46} height={46} className="size-12 rounded-full shadow-sm" alt="" />
                                            <div className="ms-3">
                                    ...
                                    <td className="p-3 border border-gray-100 dark:border-gray-800">
                                        <div className="flex items-center mb-3">
                                            <Image src="/images/client/04.jpg" width={46} height={46} className="size-12 rounded-full shadow-sm" alt="" />
                                            <div className="ms-3">
                                ...
                                <tr>
                                    <th className="text-center border border-gray-100 dark:border-gray-800 py-5">02:00PM</th>
                                    <td className="border border-gray-100 dark:border-gray-800"></td>
                                    <td className="border border-gray-100 dark:border-gray-800"></td>
                                    <td className="p-3 border border-gray-100 dark:border-gray-800">
                                        <div className="flex items-center mb-3">
                                            <Image src="/images/client/06.jpg" width={46} height={46} className="size-12 rounded-full shadow-sm" alt="" />
                                            <div className="ms-3">
                                ...
                                <tr>
                                    <th className="text-center border border-gray-100 dark:border-gray-800 py-5">04:00PM</th>
                                    <td className="border border-gray-100 dark:border-gray-800"></td>
                                    <td className="border border-gray-100 dark:border-gray-800"></td>
                                    <td className="border border-gray-100 dark:border-gray-800"></td>
                                    <td className="p-3 border border-gray-100 dark:border-gray-800">
                                ...
                                <tr>
                                    <th className="text-center border border-gray-100 dark:border-gray-800 py-5">06:00PM</th>
                                    <td className="p-3 border border-gray-100 dark:border-gray-800">
                                        <div className="flex items-center mb-3">
                                            <Image src="/images/client/03.jpg" width={46} height={46} className="size-12 rounded-full shadow-sm" alt="" />
                                            <div className="ms-3">
                                ...
                                <tr>
                                    <th className="text-center border border-gray-100 dark:border-gray-800 py-5">09:00PM</th>
                                    <td className="border border-gray-100 dark:border-gray-800"></td>
                                    <td className="p-3 border border-gray-100 dark:border-gray-800">
                                        <div className="flex items-center mb-3">
                                            <Image src="/images/client/04.jpg" width={46} height={46} className="size-12 rounded-full shadow-sm" alt="" />
                ...
                <div className="grid md:grid-cols-12 grid-cols-1 mt-8 gap-[30px]">
                    {teamData.slice(0,4).map((item:TeamData,index:number)=>{
                        return(
                            ...
                            <div className="team p-6 rounded-md border border-gray-100 dark:border-gray-800 group bg-white dark:bg-slate-900">
