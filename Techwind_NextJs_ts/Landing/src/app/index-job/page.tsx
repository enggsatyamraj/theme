    ...
    return(
        ...
        <section className="md:h-screen py-36 h-auto relative flex items-center background-effect overflow-hidden  bg-cover" style={{backgroundImage:"url('/images/job/job.jpg')"}}>
            <div className="container-fluid">
                <div className="absolute inset-0 z-0 bg-cover block dark:hidden" style={{backgroundImage:"url('/images/job/curve-shape.png')"}}></div>
                <div className="absolute inset-0 z-0 bg-cover hidden dark:block" style={{backgroundImage:"url('/images/job/curve-shape-dark.png')"}}></div>
            </div>
            ...
            <div className="container relative">
                ...
                <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    {jobData.slice(0,6).map((item:JobData,index:number)=>{
                        return(
                            <div className="rounded-md shadow-sm dark:shadow-gray-800" key={index}>
                                <div className="p-6">
                                ...
                                <div className="flex items-center p-6 border-t border-gray-100 dark:border-gray-800">
