                        ...
                        <div className="subcribe-form mt-6 mb-3">
                            <form className="relative max-w-md mx-auto lg:ms-0">
                                <div className="relative">
                                    ...
                                    <input type="email" id="aiemail" name="email" className="pt-4 pe-40 pb-4 pl-10 w-full h-[50px] outline-none text-black dark:text-white rounded-md bg-white/70 dark:bg-slate-900/70 border border-gray-100 dark:border-gray-800" placeholder="support@techwind.com"/>
                                </div>
        ...
        <section className="relative md:py-24 py-16">
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid grid-cols-1 mt-8 gap-[30px]">
                    {priceData.map((item:PriceData, index:number)=>{
                        return(
