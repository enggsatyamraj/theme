                ...
                <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                    <div className="lg:col-span-8 md:col-span-6">
                        <div className="p-6 rounded-md shadow-sm dark:shadow-gray-800">
                            ...
                            <PortfolioDetailFilter columns="columns-4"/>
                            
                            <div className="text-center mt-12">
                                <span className="bg-indigo-600 inline-block text-white text-xs font-semibold px-2.5 py-0.5 rounded-full h-5">Photography</span>
                                <h3 className="my-3 text-[26px] font-semibold">Get Ready To Up Your <br /> Creative Game With The New DJI Mavic Air 2</h3>
                                ...
                                <ul className="list-none mt-6">
                                    ...
                                    <li className="inline-block font-semibold text-slate-400 mx-4"> <span className="text-slate-900 dark:text-white block">Date :</span> <span className="block">19th June, 2025</span></li>
                        ...
                        <div className="p-6 rounded-md shadow-sm dark:shadow-gray-800 mt-8">
                            ...
                            <div className="mt-8">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center">
                                        <Image src="/images/client/01.jpg" height={44} width={44} className="size-11 rounded-full shadow-sm" alt="" />
                            ...
                            <div className="mt-8">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center">
                                        <Image src="/images/client/02.jpg" height={44} width={44} className="size-11 rounded-full shadow-sm" alt="" />
                            ...
                            <div className="mt-8">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center">
                                        <Image src="/images/client/03.jpg" height={44} width={44} className="size-11 rounded-full shadow-sm" alt="" />
                            ...
                            <div className="mt-8">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center">
                                        <Image src="/images/client/04.jpg" height={44} width={44} className="size-11 rounded-full shadow-sm" alt="" />
