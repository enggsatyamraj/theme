                           ...
                           <div className="md:me-6">
                              ...
                              <div className="subcribe-form mt-6 mb-3">
                                  <form className="relative max-w-xl">
                                      <input type="email" id="subcribe" name="email" className="pt-4 pe-40 pb-4 ps-6 w-full h-[50px] outline-none text-black dark:text-white rounded-full bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800 border-gray-100 dark:border-gray-800" placeholder="Your Email Address :" />
                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px] relative">
                    <div className="lg:col-span-8 md:col-span-12">
                        ...
                        <div className="grid md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                            ...
                            <div className="px-6 py-10 shadow-sm hover:shadow-md dark:shadow-gray-800 dark:hover:shadow-gray-700 transition duration-500 rounded-2xl bg-white dark:bg-slate-900">
        ...
        <section className="relative md:py-24 py-16 overflow-hidden">
            ...
            <div className="container relative md:mt-24 mt-16">
                <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-[30px]">
                    {contactData.map((item:ContactData, index:number)=>{
                       let Icons = item.icon
                        return(
                            <div className="text-center px-6" key={index}>
                                <div className="w-20 h-20 bg-indigo-600/5 text-indigo-600 rounded-xl text-3xl flex align-middle justify-center items-center shadow-xs dark:shadow-gray-800 mx-auto">
