        ...
        <section className="relative md:pb-24 pb-16">
                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                    <div className="md:col-span-5">
                        <div className="relative">
                            <div className="p-5 shadow-sm dark:shadow-gray-800 rounded-t-full bg-gray-50 dark:bg-slate-800">
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    ...
                    {
                        propertyData.slice(0,6).map((data:PropertyData,index:number) => {
                            return (
                                <div key={index} className="group rounded-md bg-white dark:bg-slate-900 shadow-sm hover:shadow-xl dark:hover:shadow-xl dark:shadow-gray-800 dark:hover:shadow-gray-700 overflow-hidden ease-in-out duration-500">
                                    <div className="relative">
                                        <Image src={data.image} width={0} height={0} sizes="100vw" style={{width:"100%", height:"auto"}} alt="" />

                                        <div className="absolute top-6 end-6">
                                            <Link href="#" className="size-9 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-lg text-center bg-white dark:bg-slate-900 border-0 shadow-sm dark:shadow-gray-800 rounded-full text-red-600"><i className="mdi mdi-heart"></i></Link>
                                        </div>
                                    </div>
