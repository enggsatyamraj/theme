        ...
        <>
            ...
            <section className="relative md:py-24 py-16 overflow-hidden" >
                ...
                <div className="container relative md:mt-24 mt-16">
                    <div className="grid grid-cols-1 pb-8 text-center wow animate__animated animate__fadeInUp" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div className="grid md:grid-cols-2 grid-cols-1 items-center mt-16 gap-[30px]">
                        ...
                        <div className="lg:ms-8" data-aos="fade-right" data-aos-delay="200">
                ...
                <div className="container relative md:mt-24 mt-16">
                    <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                        <div className="relative order-1 md:order-2" data-aos="fade-right" data-aos-delay="200">
                        ...
                        <div className="lg:me-8 order-2 md:order-1" data-aos="fade-left" data-aos-delay="200">
                ...
                <div className=" md:mt-24 mt-16" data-aos="fade-up" data-aos-delay="100">
