    ...
    return(
            ...
            <div className="container relative">
                <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1">
                    <div className="group relative p-6 hover:bg-indigo-600 dark:hover:bg-indigo-600 transition-all duration-500 ease-in-out bg-white dark:bg-slate-900 overflow-hidden text-center">
                        <div className="w-20 h-20 bg-indigo-600 group-hover:bg-white text-white group-hover:text-indigo-600 rounded-full text-2xl flex align-middle justify-center items-center shadow-xs dark:shadow-gray-800 dark:group-hover:shadow-gray-700 mx-auto">
                    ...
                    <div className="group relative p-6 bg-indigo-600 dark:hover:bg-indigo-600 transition-all duration-500 ease-in-out overflow-hidden text-center">
                        <div className="w-20 h-20 bg-white text-indigo-600 rounded-full text-2xl flex align-middle justify-center items-center shadow-xs dark:shadow-gray-600 mx-auto">
                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                    <div className="lg:col-span-5 md:col-span-6">
                        <div className="relative">
                            <div className="relative">
                                <img src="/images/law/ab1.jpg" className="lg:w-[400px] w-[280px]" alt="" />
                                <VideoModalTwo/>
                            </div>
                            <div className="absolute -end-5 -bottom-16">
                                <img src="/images/law/ab2.jpg" className="lg:w-[280px] w-[200px] border-8 border-white dark:border-slate-900" alt="" />
                            </div>
                        </div>
                    </div>
        ...
        <div className="container relative">
            <div className="grid grid-cols-1">
                <div className="relative -top-[52px] shadow-sm dark:shadow-gray-800 py-6 bg-white dark:bg-slate-900">
                   <CompanyLogo/>
                </div>
            </div>
        </div>
        ...
        <section className="relative md:pt-11 pt-3 md:pb-24 pb-16 overflow-hidden">
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    {lowClient.map((item:ClientData,index:number)=>{
                        return(
                            <ul className="space-y-8" key={index}>
                                <li className="shadow-sm dark:shadow-gray-800 p-6">
                                    <div className="flex items-center pb-6 border-b border-gray-100 dark:border-gray-800">
                                        <Image src={item.image} width={64} height={64} className="size-16 rounded-full shadow-sm dark:shadow-gray-800" alt="" />
                                ...
                                <li className="shadow-sm dark:shadow-gray-800 p-6">
                                    <div className="flex items-center pb-6 border-b border-gray-100 dark:border-gray-800">
                                        <Image src={item.image1} width={64} height={64} className="size-16 rounded-full shadow-sm dark:shadow-gray-800" alt="" />
