  ...
  return (
    <>
        ...
        <div className="container relative">
          <div className="grid md:grid-cols-12 grid-cols-1 items-center mt-10 gap-[30px]">
            <div className="md:col-span-7">
              <div className="me-6">
                <h4 className="font-semibold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-5 text-red dark:text-white">Our Creativity Is Your <span className="text-indigo-600">Success</span></h4>
        ...
        <div className="container relative md:mt-24 mt-16">
          <div className="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 items-center mt-10 gap-[30px]">
            <div className="lg:col-span-5 md:order-2 order-1">
              <div className="lg:ms-10">
                <div className="bg-white dark:bg-slate-900 p-6 rounded-md shadow-sm dark:shadow-gray-800">
                      ...
                      <div className="grid grid-cols-1">
                        <div className="mb-5">
                          ...
                          <div className="form-icon relative mt-2">
                            ...
                            <input type="text" className="form-input ps-12 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0" placeholder="Name" name="name" />
                          </div>
                        </div>
                        ...
                        <div className="mb-5">
                          ...
                          <div className="form-icon relative mt-2">
                            ...
                            <input type="password" className="form-input ps-12 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0" placeholder="Password" />
                          </div>
                        </div>
                  ...
                  return(
                    <div className="tiny-slide" key={index}>
                      <div className="lg:flex p-6 lg:p-0 relative rounded-md shadow-sm dark:shadow-gray-800 overflow-hidden m-2" >
                        <img className="size-24 lg:w-48 lg:h-auto lg:rounded-none rounded-full mx-auto" src={item.image} alt=""/>
      ...
      <section className="relative md:py-24 py-16 bg-gray-50 dark:bg-slate-800">
        ...
        <GetInTuct className="container relative md:mt-24 mt-16 md:mb-12" title={false}/>
      </section>
