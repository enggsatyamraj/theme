                        ...
                        <div className="md:me-6 relative z-2">
                            ...
                            <div className="subcribe-form mt-6 mb-3">
                                <form className="relative max-w-xl">
                                    <input type="email" id="subcribe" name="email" className="pt-4 pe-40 pb-4 ps-6 w-full h-[50px] outline-none text-black dark:text-white rounded-full bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800 border-gray-100 dark:border-gray-800" placeholder="Enter your mail" />
                    ...
                    <div className="lg:col-span-7">
                        <div className="relative">
                            ...
                            <div className="md:w-72 w-64 absolute md:-top-4 top-0 lg:start-0 md:-start-14 start-0 z-2">
                                <div className="p-5 bg-white dark:bg-slate-900 rounded-md shadow-sm dark:shadow-gray-800">
                            ...
                            <div className="md:w-[350px] w-72 absolute top-1/3 start-1/2 ltr:-translate-x-1/2 rtl:translate-x-1/2 z-3">
                                <div className="p-5 bg-indigo-600 rounded-md shadow-sm dark:shadow-gray-800">
        ...
        <section className="relative md:pt-24 py-16">
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-[30px]">
                    {paymentFeature.map((item:Feature,index:number)=>{
                        let Icons = item.icon
                        return(
                            <div key={index} className={`p-6 transition duration-500 rounded-2xl mt-6 text-center ${item.class}`}>
