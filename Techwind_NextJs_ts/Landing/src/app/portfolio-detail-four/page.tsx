                    ...
                    <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                        <div className="lg:col-span-4 md:col-span-5">
                            <div className="bg-gray-50 dark:bg-slate-800 shadow-sm dark:shadow-gray-800 p-6 rounded-md">
                                <h5 className="text-lg font-semibold border-b border-gray-100 dark:border-gray-800 pb-3 mb-3">Project Info :</h5>
                        ...
                        <div className="lg:col-span-8 md:col-span-7">
                            <div className="lg:me-5">
                                <h4 className="text-xl font-semibold mb-3 border-b border-gray-100 dark:border-gray-800 pb-3">Project Name :</h4>
