...
export default function Page(){
    const images = ['/images/hotel/bg1.jpg','/images/hotel/bg2.jpg','/images/hotel/bg3.jpg'];
                            ...
                            <form className="mt-4" >
                                <div className="grid lg:grid-cols-5 md:grid-cols-2 grid-cols-1 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" min="0"  id="adult" className="form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0" placeholder="Adults :" />
                                    </div>

                                    <div>
                                        <label className="font-semibold">Childrens :</label>
                                        <input type="number" min="0"  id="childrens" className="form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0" placeholder="Childrens :" />
                                    </div>
        ...
        <section className="relative md:py-24 py-16 overflow-hidden">
                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                    <div className="lg:col-span-5 md:col-span-6">
                        <div className="relative">
                            <img src="/images/hotel/ab1.jpg" className="rounded-full lg:w-[400px] w-[280px]" alt="" />
                            <div className="absolute -end-5 -bottom-16">
                                <img  src="/images/hotel/ab2.jpg" className="rounded-full lg:w-[280px] w-[200px] border-8 border-white dark:border-slate-900" alt="" />
                            </div>
                        </div>
                    </div>
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-1 gap-[30px] mt-8">
                    ...
                    {
                        hotelData.map((Data:HotelData,index:number) => {
                            return (
