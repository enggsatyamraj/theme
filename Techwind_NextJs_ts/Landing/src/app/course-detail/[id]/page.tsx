...
export default function Page(){
    ...
    const data:CoursList | undefined = courcesData.find((course) => course?.id === id);
        ...
        <section className="relative table w-full py-36 lg:py-44 bg-no-repeat bg-center bg-cover" style={{backgroundImage:"url('/images/course/cta.jpg')"}}>
            ...
            <div className="container relative">
                <div className="grid grid-cols-1 pb-8 text-center mt-10">
                    ...
                    <h3 className="mt-3 text-3xl leading-normal font-medium text-white">{data?.subTitle}</h3>
                    <div className="flex items-center mx-auto mt-3">
                        <Image src={data?.image2 ?? ""} width={40} height={40} className="size-10 rounded-full shadow-md dark:shadow-gray-800" alt="" />
                        <Link href="#" className="font-semibold text-white block ms-3">{data?.name}</Link>
                    </div>
                </div>
            </div>
        ...
        <section className="relative md:py-24 py-16 overflow-hidden">
            <div className="container relative">
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 mt-6 gap-[30px]">
                    <Image src="/images/course/c3.jpg" width={0} height={0} sizes='100vw' style={{width:"100%", height:"auto"}} className="rounded-md shadow-sm" alt="" />

                    <div className="relative">
                        <Image src="/images/course/c8.jpg" width={0} height={0} sizes='100vw' style={{width:"100%", height:"auto"}} className="rounded-md shadow-sm" alt="" />
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 pt-6 gap-[30px]">
                    ...
                    {
                        courseDetail.map((data:CourseDetail, index:number) => {
                            return (
