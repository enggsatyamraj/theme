        ...
        <section className="relative md:py-24 py-16">
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid md:grid-cols-3 grid-cols-1 mt-8 gap-[30px]">
                    {businessAbout.map((item:About,index:number)=>{
                        let Icons = item.icon
                        return(
        ...
        <section className="relative md:py-24 py-16">
            <div className="container relative">
                ...
                <div className="grid lg:grid-cols-3 md:grid-cols-2 mt-8 gap-[30px]">
                    {PricingData.map((item:PriceData,index:number)=>{
                        return(
                            <div key={index} className="group border-b-[3px] border-gray-200 dark:border-gray-800 hover:border-indigo-600 dark:hover:border-indigo-600 duration-500 hover:scale-105 relative shadow-sm dark:shadow-gray-800 rounded-md bg-white dark:bg-slate-900">
