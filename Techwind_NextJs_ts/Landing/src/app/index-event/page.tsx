                    ...
                    <div className="lg:col-span-7 mt-8 lg:mt-0">
                        <div className="lg:ms-8">
                            <div className="grid md:grid-cols-2 grid-cols-1 md:gap-0 gap-[30px]">
                                <div className="group border-b-[3px] border-gray-200 dark:border-gray-800 relative shadow-sm dark:shadow-gray-800 rounded-md md:scale-110 z-3 bg-white dark:bg-slate-900">
                                ...
                                <div className="group border-b-[3px] border-gray-200 dark:border-gray-800 relative shadow-sm dark:shadow-gray-800 rounded-md z-2 bg-gray-50 dark:bg-slate-800">
