        ...
        <section className="relative md:py-24 py-16">
                    ...
                    <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                        ...
                        <div className="subcribe-form z-1">
                            <form className="relative max-w-xl">
                                <input type="text" id="subcribe" name="email" className="pt-4 pe-40 pb-4 ps-6 w-full h-[50px] outline-none text-black dark:text-white rounded-full bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800" placeholder="Your Email Address :" />
                ...
                <div className="grid md:grid-cols-12 grid-cols-1 mt-8 gap-[30px]">
                    <div className="lg:col-span-8 md:col-span-6">
                        <div className="grid grid-cols-1 gap-[30px]">
                            {blogData.slice(0,7).map((item:BlogData,index:number)=>{
                                return(
                                <div key={index} className="blog relative rounded-md shadow-sm dark:shadow-gray-800 overflow-hidden">
                    ...
                    <div className="lg:col-span-4 md:col-span-6">
                        <div className="sticky top-20">
                            <h5 className="text-lg font-semibold bg-gray-50 dark:bg-slate-800 shadow-sm dark:shadow-gray-800 rounded-md p-2 text-center">Recent post</h5>
                            <div className="flex items-center mt-8">
                                <Image src="/images/blog/06.jpg" width={96} height={64} className="h-16 rounded-md shadow-sm dark:shadow-gray-800" alt="" />
                            ...
                            <div className="flex items-center mt-4">
                                <Image src="/images/blog/07.jpg" width={96} height={64} className="h-16 rounded-md shadow-sm dark:shadow-gray-800" alt="" />
                            ...
                            <div className="flex items-center mt-4">
                                <Image src="/images/blog/08.jpg" width={96} height={64} className="h-16 rounded-md shadow-sm dark:shadow-gray-800" alt="" />
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    {masonryData.map((item:MasonryData,index:number)=>{
                        return(
                            <div className="flex items-center" key={index}>
                                <Image src={item.image} width={110} height={80} className="lg:h-20 h-16 rounded-md shadow-sm dark:shadow-gray-800" alt="" />
