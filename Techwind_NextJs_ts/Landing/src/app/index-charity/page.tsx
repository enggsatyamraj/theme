                                    ...
                                    <div>
                                        <div className="grid md:grid-cols-2 gap-5">
                                            <div className="mb-5">
                                                ...
                                                <input type="text" className="form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0" placeholder="Name" name="name"/>
                                            </div>

                                            <div className="mb-5">
                                                <label className="form-label font-medium">Your Email : <span className="text-red-600">*</span></label>
                                                <input type="email" className="form-input mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-indigo-600 dark:border-gray-800 dark:focus:border-indigo-600 focus:ring-0" placeholder="Email" name="email"/>
                                            </div>
                                        </div>
                                    </div>
        ...
        <section className="relative md:py-24 py-16">
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    ...
                    {ourCausesData.map((item:CausesData,index:number)=>{
                        return(
                            <div key={index} className="group relative rounded hover:-mt-1 shadow-sm hover:shadow-md dark:shadow-gray-800 overflow-hidden transition-all duration-300">
