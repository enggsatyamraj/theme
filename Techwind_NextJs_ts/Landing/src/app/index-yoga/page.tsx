        ...
        <section className="relative overflow-hidden md:py-24 py-16">
                        ...
                        <div className="grid grid-cols-12 gap-6 items-center relative">
                            <div className="col-span-6">
                                <div className="grid grid-cols-1 gap-6">
                                    <Image src="/images/yoga/ab03.jpg" width={0} height={0} sizes='100vw' style={{width:"100%", height:"auto"}} className="shadow-sm rounded-md" alt="" />
                                    <Image src="/images/yoga/ab02.jpg" width={0} height={0} sizes='100vw' style={{width:"100%", height:"auto"}} className="shadow-sm rounded-md" alt="" />
                                </div>
                            </div>

                            <div className="col-span-6">
                                <div className="grid grid-cols-1 gap-6">
                                    <Image src="/images/yoga/ab01.jpg" width={0} height={0} sizes='100vw' style={{width:"100%", height:"auto"}} className="shadow-sm rounded-md" alt="" />
                                </div>
                            </div>
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-3 mt-8 gap-[30px]">
                    {meditationData.map((item:MeditationData,index:number)=>{
            ...
            <div className="container relative md:mt-24 mt-16">
                <div className="grid grid-cols-1">
                    <div className="relative overflow-hidden bg-indigo-600 rounded-md shadow-sm dark:shadow-gray-700">
                            ...
                            <div>
                                <div className="text-white p-4">
                                    ...
                                    <ul className="list-none text-white/50 mt-4">
                                        <li className="mb-1 flex items-center"><BsCheckCircle className="text-white text-base me-2"/> Digital Marketing Solutions for Tomorrow</li>
                                        <li className="mb-1 flex items-center"><BsCheckCircle className="text-white text-base me-2"/> Our Talented & Experienced Marketing Agency</li>
                                        <li className="mb-1 flex items-center"><BsCheckCircle className="text-white text-base me-2"/> Create your own skin to match your brand</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
        ...
        <section className="relative md:py-24 py-16">
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid md:grid-cols-12 grid-cols-1 mt-8 gap-[30px]">
                    {yogaTeam.map((item:TeamData,index:number)=>{
                        return(
