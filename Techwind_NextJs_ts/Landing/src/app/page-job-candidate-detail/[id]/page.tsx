...
export default function Page(){
    ...
    const candidate:Candidate | undefined = candidates.find((candidats)=>candidats?.id === id);
                        ...
                        <div className="lg:-mt-[330px] -mt-[299px]">
                            <div className="rounded-md bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800">
                                <div className="text-center py-8 p-6 border-b border-gray-100 dark:border-gray-800">
                                    <Image src={candidate?.image ?? ""} width={96} height={96} className="size-24 p-1 shadow-md dark:shadow-gray-800 mx-auto rounded-full block" alt="" />
