        ...
        <div className="container relative md:mt-24 mt-16">
            <div className="grid md:grid-cols-2 grid-cols-1 items-center mt-16 gap-[30px]">
                ...
                <div className="lg:ms-8">
                    ...
                    <div className="pt-6 flex items-center border-t border-gray-200 dark:border-gray-800">
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                <div className="relative order-1 md:order-2">
                    <div className="grid grid-cols-12 items-center gap-4 lg:gap-0">
                        <div className="col-span-6">
                            <div className="grid grid-cols-1 lg:gap-6 gap-4">
                                <Image src="/images/notification.jpg" width={0} height={0} sizes="100vw" style={{width:"100%", height:"auto"}} className="shadow-sm rounded-md lg:max-w-[240px] mx-auto" alt="" />
                                <Image src="/images/about/ab02.jpg" width={0} height={0} sizes="100vw" style={{width:"100%", height:"auto"}} className="shadow-sm rounded-md lg:max-w-[240px] mx-auto" alt="" />
                            </div>
                        </div>

                        <div className="col-span-6">
                            <div className="grid grid-cols-1">
                                <Image src="/images/about/ab01.jpg" width={0} height={0} sizes="100vw" style={{width:"100%", height:"auto"}} className="shadow-sm rounded-md lg:max-w-[240px] mx-auto" alt="" />
                            </div>
                        </div>
                    </div>
                    <div className="overflow-hidden absolute md:size-[500px] size-[400px] bg-gradient-to-tl to-indigo-600/20 via-indigo-600/70 from-indigo-600 bottom-1/2 translate-y-1/2 md:start-0 start-1/2 ltr:md:translate-x-0 ltr:-translate-x-1/2 rtl:md:translate-x-0 rtl:translate-x-1/2 -z-1 shadow-md shadow-indigo-600/10 rounded-full"></div>
                    ...
                    <div className="absolute flex justify-between items-center md:bottom-16 bottom-0 end-5 rounded-lg shadow-md dark:shadow-gray-800 lg:w-72 w-48 m-3">
                        <Image src="/images/sales-chart.jpg" width={0} height={0} sizes="100vw" style={{width:"100%", height:"auto"}} className="rounded-lg shadow-sm dark:shadow-gray-800" alt="" />
                    </div>
                </div>
