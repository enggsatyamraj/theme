...
export default function Page(){
    return(
        ...
        <div className="relative">
            <div className="shape absolute sm:-bottom-px -bottom-[2px] start-0 end-0 overflow-hidden text-gray-50 dark:text-slate-900">
                        ...
                        <div className="grid grid-cols-12 gap-6 items-center">
                            <div className="col-span-6">
                                <div className="grid grid-cols-1 gap-6">
                                    <Image src="/images/about/ab03.jpg" width={0} height={0} sizes='100vw' style={{width:"100%", height:"auto"}} className="shadow-smrounded-md" alt="" />
                                    <Image src="/images/about/ab02.jpg" width={0} height={0} sizes='100vw' style={{width:"100%", height:"auto"}} className="shadow-smrounded-md" alt="" />
                                </div>
                            </div>

                            <div className="col-span-6">
                                <div className="grid grid-cols-1 gap-6">
                                    <Image src="/images/about/ab01.jpg" width={0} height={0} sizes='100vw' style={{width:"100%", height:"auto"}} className="shadow-smrounded-md" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="lg:flex justify-center mt-8">
                    <div className="lg:w-3/4">
                        <div className="group md:flex items-center justify-between p-6 rounded-lg shadow-sm hover:shadow-lg dark:shadow-gray-700 transition-all duration-500">
                            <div>
                        ...
                        <div className="group md:flex items-center justify-between p-6 rounded-lg shadow-sm hover:shadow-lg dark:shadow-gray-700 transition-all duration-500 mt-6">
                            <div>
