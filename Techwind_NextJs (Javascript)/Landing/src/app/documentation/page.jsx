                ...
                <div className="container relative">
                    <div className="grid grid-cols-1 items-center gap-[30px]">
                        <div>
                            ...
                            <p className="text-slate-400 text-base leading-8"><strong>Techwind</strong> is a fully responsive, clean and modern high-converting Next Js landing page template. It is a beautifully handcrafted, pixel perfect HTML5 landing page template based on the <b>Next 13.x., React 18.X and Tailwind CSS v4.x.</b>. Techwind is a Powerful Next Js Multipurpose Landing Page Template. It is an excellent template for startup, cloud hosting, business, corporate, minimal portfolio single product (Smartwatch) , Saas, Social media marketing, Digital marketing/agency, Email Templates, Marketing, Agency, Careers and Jobs, Helpcenter, and much more.</p>
