                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                    <div className="md:col-span-5">
                        <div className="relative">
                            <div className="pe-12">
                                <img src="/images/construction/ab01.jpg" className="rounded-md" alt="" />
                            </div>

                            <div className="absolute bottom-16 end-0">
                                <img src="/images/construction/ab02.jpg" className="rounded-md rounded-ee-[30px] shadow-md w-56 h-56" alt="" />
                                <VideoModalTwo/>
                            </div>
                        </div>
                    </div>
                    ...
                    {constructionProject.map((item,index)=>{
                        return(
                            <div className="group relative block overflow-hidden rounded-md transition-all duration-500" key={index}>
                                <Link href="/portfolio-detail-one"><Image src={item.image} width={0} height={0} sizes='100vw' style={{width:"100%", height:"auto"}} className="rounded-md shadow-sm dark:shadow-gray-800" alt="" /></Link>
