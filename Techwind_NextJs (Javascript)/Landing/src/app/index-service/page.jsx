                        ...
                        <div className="md:me-6">
                            ...
                            <div className="subcribe-form z-1 mt-8">
                                <form className="relative mx-auto max-w-2xl">
                                    ...
                                    <input type="text" id="SearchForumKeyword" name="text" className="pt-4 pe-40 pb-4 w-full h-[50px] outline-none text-black dark:text-white  bg-white/70 dark:bg-slate-900/70 border border-gray-100 dark:border-gray-700 ps-10" placeholder="What service are you looking for?" />
