    ...
    <>
      ...
      <section className="relative md:pb-24 pb-16">
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    {solarPorject.map((item,index)=>{
                        return(
                            <div key={index} className="group relative overflow-hidden rounded shadow-sm shadow-slate-100 dark:shadow-slate-800">
                                <div className="relative md:shrink-0">
                                    <Image width={0} height={0} sizes='100vw' style={{width:'100%', height:'384px'}} className="object-cover md:w-96 w-full h-96 group-hover:scale-105 duration-500" src={item.image} alt=""/>
                                </div>
