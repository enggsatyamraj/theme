...
export default function Page(){
   ...
   return(
    ...
    <section className="relative md:py-24 py-16">
        <div className="container relative">
            <div className="md:flex p-6 bg-white dark:bg-slate-900 rounded-md shadow-sm dark:shadow-gray-800">
                <div className="lg:w-1/3 md:w-2/5">
                {file ? 
                    <img src={file} alt="" /> : 
                    <p className="font-semibold mb-6">Upload your ART here, Please click Upload Image Button.</p>
                }
                    <div className="preview-box flex justify-center rounded-md shadow-sm dark:shadow-gray-800 overflow-hidden bg-gray-50 dark:bg-slate-800 text-slate-400 p-2 text-center small">Supports JPG, PNG and MP4 videos. Max file size : 10MB.</div>
