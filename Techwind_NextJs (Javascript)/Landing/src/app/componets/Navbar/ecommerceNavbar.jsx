            ...
            <div className="container relative">
                ...
                <ul className="buy-button list-none space-x-1 mb-0 flex items-center justify-center " style={{height:"74px"}}>
                    <li className="dropdown inline-block relative me-1">
                        ...
                        <div className="dropdown-menu absolute overflow-hidden end-0 m-0 mt-4 z-10 w-52 rounded-md bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800 hidden">
                    ...
                    <li className="dropdown inline-block relative">
                        ...
                        {isCart ?
                             <div className="dropdown-menu absolute end-0 m-0 mt-4 z-10 w-60 rounded-md bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800 ">
                             <ul className="py-3 text-start" aria-labelledby="dropdownDefault">
                                 <li>
                                     <Link href="/" className="flex items-center justify-between py-1.5 px-4">
                                         <span className="flex items-center">
                                             <Image src="/images/shop/items/s1.jpg" width={36} height={45} className="rounded shadow-sm dark:shadow-gray-800 w-9" alt="" />
                                             <span className="ms-3">
                                 ...
                                 <li>
                                     <Link href="/" className="flex items-center justify-between py-1.5 px-4">
                                         <span className="flex items-center">
                                             <Image src="/images/shop/items/s2.jpg" width={36} height={45} className="rounded shadow-sm dark:shadow-gray-800 w-9" alt="" />
                                             <span className="ms-3">
                                 ...
                                 <li>
                                     <Link href="/" className="flex items-center justify-between py-1.5 px-4">
                                         <span className="flex items-center">
                                             <Image src="/images/shop/items/s3.jpg" width={36} height={45} className="rounded shadow-sm dark:shadow-gray-800 w-9" alt="" />
                                             <span className="ms-3">
                    ...
                    {showModal ? <div id="ContactUs"  className="bg-gray-900 bg-opacity-50 dark:bg-opacity-80 fixed inset-0 z-40 flex items-center justify-center">
                        <div className="relative w-full h-auto max-w-lg p-4">
                            <div className="relative bg-white dark:bg-slate-900 rounded-lg shadow-sm dark:shadow-gray-800">
                                <button type="button" className="absolute -top-4 -end-4 text-gray-400 bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800 hover:text-gray-900 rounded-full text-sm p-1.5 ms-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="ContactUs">
