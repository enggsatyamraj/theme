...
export default function VideoModalFive(){
    ...
    return(
        ...
        <div className="absolute top-0 translate-y-2/4 start-0 text-center">
            <Link href="#!" onClick={()=>setOpen(!isOpen)} scroll={false} className="lightbox size-20 rounded-full shadow-lg shadow-slate-100 dark:shadow-slate-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-indigo-600">
