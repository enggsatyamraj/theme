...
export default function VideoModalFour(){
    ...
    return(
        <>
        <Link href="#" onClick={()=>setOpen(!isOpen)} scroll={false} className="lightbox size-20 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center bg-indigo-600 hover:bg-indigo-700 text-white duration-500 ease-in-out mx-auto">
