    ...
    return(
        ...
        <div className="container relative">
            <div className="grid grid-cols-1 text-center">
                ...
                <Link href="#" onClick={()=>setOpen(!isOpen)} className="lightbox size-20 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-indigo-600 mx-auto mt-10">
