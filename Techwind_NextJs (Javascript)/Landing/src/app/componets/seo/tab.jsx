                    ...
                    <div className="lg:col-span-8 md:col-span-7">
                        <div id="myTabContent" className="p-6 bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800 rounded-md">
                            <div role="tabpanel" aria-labelledby="profile-tab">
                                <Image src={ block === 0 ? "/images/cowork/7.jpg": block === 1 ? "/images/cowork/8.jpg" : block === 2 ? "/images/cowork/9.jpg" : '' } width={0} height={0} sizes='100vw' style={{width:"100%", height:"auto"}} className="shadow-sm rounded-md" alt="" />
                            </div>
