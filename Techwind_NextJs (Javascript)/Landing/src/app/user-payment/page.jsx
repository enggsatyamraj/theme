            ...
            <div className="container relative md:mt-24 mt-16">
                <div className="md:flex">
                    ...
                    <div className="lg:w-3/4 md:w-2/3 md:px-3 mt-[30px] md:mt-0">
                        ...
                        <div className="rounded-md shadow-sm dark:shadow-gray-800 bg-white dark:bg-slate-900 mt-6">
                                        ...
                                        return(
                                            <li className="flex justify-between items-center py-6" key={index}>
                                                <div className="flex items-center">
                                                    <Image src={item.image} width={48} height={32} className="rounded shadow-sm dark:shadow-gray-800 w-12" alt="" />
                                                ...
                                                <div>
                                                    <Link href="#" className="size-9 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center bg-red-600/5 hover:bg-red-600 border-red-600/10 hover:border-red-600 text-red-600 hover:text-white rounded-full"><Icon.Trash2 className="size-4"></Icon.Trash2></Link>
                                                </div>
                                            </li>
                                        )
                                    })}
