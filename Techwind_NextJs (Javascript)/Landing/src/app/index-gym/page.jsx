            ...
            <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                <div className="md:col-span-5">
                    <div className="relative">
                        <div className="pe-12">
                            <img src="/images/gym/about01.jpg" className="rounded-md" alt="" />
                        </div>

                        <div className="absolute bottom-16 end-0">
                            <img src="/images/gym/about02.jpg" className="rounded-md shadow-md w-48 h-48" alt="" />
    ...
    <section className="relative md:py-24 py-16">
        ...
        <div className="container relative md:mt-24 mt-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 mt-8 gap-[30px]">
                {blogData.slice(6,9).map((item,index)=>{
                    return(
