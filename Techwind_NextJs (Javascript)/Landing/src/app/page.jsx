                  ...
                  return(
                    <div className="tiny-slide" key={index}>
                      <div className="lg:flex p-6 lg:p-0 relative rounded-md shadow-sm dark:shadow-gray-800 overflow-hidden m-2" >
                        <Image className="size-24 lg:w-48 lg:h-auto lg:rounded-none rounded-full mx-auto" src={item.image} alt="" width={0} height={0} sizes="100vw" style={{width:"192px", height:"auto"}}/>
