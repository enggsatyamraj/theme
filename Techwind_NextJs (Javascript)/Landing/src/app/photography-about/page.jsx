                    ...
                    <div className="rounded-md shadow dark:shadow-gray-800 overflow-hidden">
                        <div className="md:flex items-center">
                            <div className="relative md:shrink-0">
                                <Image src="/images/photography/about.jpg" width={0} height={0} sizes='100vw' style={{width:"500px", height:"auto"}} className="h-full w-full object-cover lg:w-[500px] md:w-80 lg:h-full md:h-96" alt="" />
                            </div>
                    ...
                    {photoAboutImage.map((data,index) => {
                        return (
                            <div className="mx-auto" key={index}>
                                <Image src={data} width={0} height={0} sizes='100vw' style={{width:"110px", height:""}} className="size-[110px] grayscale hover:grayscale-0 duration-500 ease-in-out" alt="" />
                            </div>
                        )
                    })}
